...
//        Response(long, std::string &&, std::string const&); //TODO: incomplete function definition // _ZN10Automation8ResponseC2ENS0_4TypeEONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKS7_
