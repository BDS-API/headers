...
namespace Social {
    ...
    namespace Events {
        ...
        public:
            ...
            Event(unsigned int, std::string const&, std::unordered_map<std::string, Social::Events::Property, std::hash<std::string>, long, std::allocator<std::pair<std::string const, Social::Events::Property>>> &&, int); // _ZN6Social6Events5EventC2EjRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEOSt13unordered_mapIS7_NS0_8PropertyESt4hashIS7_ESt8equal_toIS7_ESaISt4pairIS8_SB_EEEi
            ...
            bool shouldAggregate()const; // _ZNK6Social6Events5Event15shouldAggregateEv
        };
    }
}
