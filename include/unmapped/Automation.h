...
//    std::string MessagePurposeTypeToString(long); //TODO: incomplete function definition // _ZN10Automation26MessagePurposeTypeToStringB5cxx11ENS_14MessagePurposeE
