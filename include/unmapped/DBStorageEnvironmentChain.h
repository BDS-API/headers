...
//    bool isContentKeyValid(long *, Core::Path const&, ContentIdentity const&, std::string const&, std::shared_ptr<Core::FileStorageArea>); //TODO: incomplete function definition // _ZN25DBStorageEnvironmentChain17isContentKeyValidEPN7leveldb3EnvERKN4Core4PathERK15ContentIdentityRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt10shared_ptrINS3_15FileStorageAreaEE
//    void createFlushableEnv(long *, std::shared_ptr<Core::FileStorageArea>, Core::Path const&); //TODO: incomplete function definition // _ZN25DBStorageEnvironmentChain18createFlushableEnvEPN7leveldb3EnvESt10shared_ptrIN4Core15FileStorageAreaEERKNS4_4PathE
