...
namespace Social {
    ...
    namespace Events {
        ...
        public:
            ...
            void addListener(std::unique_ptr<long>); // _ZN6Social6Events12EventManager11addListenerESt10unique_ptrINS0_14IEventListenerESt14default_deleteIS3_EE
            ...
            void buildCommonProperties(std::unordered_map<std::string, Social::Events::Property, std::hash<std::string>, long, std::allocator<std::pair<std::string const, Social::Events::Property>>> &, unsigned int)const; // _ZNK6Social6Events12EventManager21buildCommonPropertiesERSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS0_8PropertyESt4hashIS8_ESt8equal_toIS8_ESaISt4pairIKS8_S9_EEEj
