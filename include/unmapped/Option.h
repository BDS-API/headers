...
public:
    virtual ~Option(); // _ZN6OptionD2Ev
    virtual void __fake_function0(); // fake
    virtual void load(std::map<std::string, std::string, long, std::allocator<std::pair<std::string const, std::string>>> &); // _ZN6Option4loadERSt3mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES6_St4lessIS6_ESaISt4pairIKS6_S6_EEE
    virtual void load(Json::Value const&); // _ZN6Option4loadERKN4Json5ValueE
//    Option(long, long, long, std::string const&, std::string const&, long); //TODO: incomplete function definition // _ZN6OptionC2E8OptionID15OptionOwnerType16OptionResetFlagsRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESA_10OptionType
    ...
    void registerObserver(void *, std::function<void (Option *)>, std::function<void (Option *, long)>); // _ZN6Option16registerObserverEPvSt8functionIFvPS_EES1_IFvS2_9InputModeEE
    ...
    void registerObserver(void *, std::function<void (Option *, long)>); // _ZN6Option16registerObserverEPvSt8functionIFvPS_9InputModeEE
    void getFloat()const; // _ZNK6Option8getFloatEv
//    void getFloat(long)const; //TODO: incomplete function definition // _ZNK6Option8getFloatE9InputMode
    void getBool()const; // _ZNK6Option7getBoolEv
//    void getBool(long)const; //TODO: incomplete function definition // _ZNK6Option7getBoolE9InputMode
...
//    void set(long, float); //TODO: incomplete function definition // _ZN6Option3setE9InputModef
//    void set(long, bool); //TODO: incomplete function definition // _ZN6Option3setE9InputModeb
...
//    void reset(long); //TODO: incomplete function definition // _ZN6Option5resetE9InputMode
...
//    void notifyOptionValueChanged(long, bool); //TODO: incomplete function definition // _ZN6Option24notifyOptionValueChangedE9InputModeb
//    bool isType(long)const; //TODO: incomplete function definition // _ZNK6Option6isTypeE10OptionType
    bool isDefaultValue()const; // _ZNK6Option14isDefaultValueEv
//    bool isDefaultValue(long)const; //TODO: incomplete function definition // _ZNK6Option14isDefaultValueE9InputMode
...
//    void read(std::string const&, long); //TODO: incomplete function definition // _ZN6Option4readERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERN3glm5tvec3IfLNS8_9precisionE0EEE
...
//    void _setOptionType(long); //TODO: incomplete function definition // _ZN6Option14_setOptionTypeE10OptionType
};
