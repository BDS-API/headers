...
//    bool hasDataOfType(std::string const&, long)const; //TODO: incomplete function definition // _ZNK12BehaviorData13hasDataOfTypeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_8DataTypeE
    ...
    public:
        virtual ~DataProxy(); // _ZN12BehaviorData9DataProxyD2Ev
        virtual void __fake_function0(); // fake
//        DataProxy(std::string const&, long); //TODO: incomplete function definition // _ZN12BehaviorData9DataProxyC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_8DataTypeE
    };
};
