...
public:
    virtual ~ServerContentKeyProvider(); // _ZN24ServerContentKeyProviderD2Ev
    ...
    virtual void setTempContentKeys(std::unordered_map<ContentIdentity, std::string, std::hash<ContentIdentity>, long, std::allocator<std::pair<ContentIdentity const, std::string>>> const&); // _ZN24ServerContentKeyProvider18setTempContentKeysERKSt13unordered_mapI15ContentIdentityNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4hashIS1_ESt8equal_toIS1_ESaISt4pairIKS1_S7_EEE
