...
//        MessageHeader(std::string const&, long, int); //TODO: incomplete function definition // _ZN10Automation13MessageHeaderC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_14MessagePurposeEi
