...
//    void add(float, float, float, long); //TODO: incomplete function definition // _ZN15BoneOrientation3addEfff17BoneTransformType
//    void scale(float, float, float, long); //TODO: incomplete function definition // _ZN15BoneOrientation5scaleEfff17BoneTransformType
...
//    void setRotationRelativeMode(long); //TODO: incomplete function definition // _ZN15BoneOrientation23setRotationRelativeModeE25BoneAnimationRelativeMode
    ...
    bool shouldOverrideStackMatrix()const; // _ZNK15BoneOrientation25shouldOverrideStackMatrixEv
    ...
    bool shouldApplyLocalPreTransformMatrix()const; // _ZNK15BoneOrientation34shouldApplyLocalPreTransformMatrixEv
