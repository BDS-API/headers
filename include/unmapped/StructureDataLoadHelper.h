...
public:
    virtual ~StructureDataLoadHelper(); // _ZN23StructureDataLoadHelperD2Ev
    ...
    virtual void loadDirection__incomplete1(long); //TODO: incomplete function definition // _ZN23StructureDataLoadHelper13loadDirectionEN9Direction4TypeE
    virtual void loadRotation__incomplete0(long); //TODO: incomplete function definition // _ZN23StructureDataLoadHelper12loadRotationE8Rotation
    virtual void loadMirror__incomplete0(long); //TODO: incomplete function definition // _ZN23StructureDataLoadHelper10loadMirrorE6Mirror
    ...
    virtual bool shouldResetTime(); // _ZN23StructureDataLoadHelper15shouldResetTimeEv
    virtual void _generateNewID(); // _ZN23StructureDataLoadHelper14_generateNewIDEv
//    StructureDataLoadHelper(BlockPos const&, BlockPos const&, Vec3 const&, ActorUniqueID, long, long, Level &); //TODO: incomplete function definition // _ZN23StructureDataLoadHelperC2ERK8BlockPosS2_RK4Vec313ActorUniqueID8Rotation6MirrorR5Level
//    StructureDataLoadHelper(BlockPos const&, BlockPos const&, Vec3 const&, ActorUniqueID, long, long, Level *); //TODO: incomplete function definition // _ZN23StructureDataLoadHelperC2ERK8BlockPosS2_RK4Vec313ActorUniqueID8Rotation6MirrorP5Level
