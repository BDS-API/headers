...
public:
    virtual ~IntOption(); // _ZN9IntOptionD2Ev
...
//    IntOption(long, long, long, std::string const&, std::string const&, int, std::vector<int> const&, bool); //TODO: incomplete function definition // _ZN9IntOptionC2E8OptionID15OptionOwnerType16OptionResetFlagsRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESA_iRKSt6vectorIiSaIiEEb
    void _validate(int); // _ZN9IntOption9_validateEi
//    IntOption(long, long, long, std::string const&, std::string const&, int, bool, int, int); //TODO: incomplete function definition // _ZN9IntOptionC2E8OptionID15OptionOwnerType16OptionResetFlagsRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESA_ibii
