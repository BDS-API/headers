...
public:
    ...
    void appendKeys(std::unordered_map<std::string, std::string, std::hash<std::string>, long, std::allocator<std::pair<std::string const, std::string>>> const&); // _ZN19PackManifestFactory10appendKeysERKSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES6_St4hashIS6_ESt8equal_toIS6_ESaISt4pairIKS6_S6_EEE
