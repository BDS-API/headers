...
//    void getNetworkStatistics(long); //TODO: incomplete function definition // _ZN19NetworkDebugManager20getNetworkStatisticsE11TrackerType
//    void trackSend(long, std::string const&, unsigned long); //TODO: incomplete function definition // _ZN19NetworkDebugManager9trackSendE11TrackerTypeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEm
//    void trackReceive(long, std::string const&, unsigned long); //TODO: incomplete function definition // _ZN19NetworkDebugManager12trackReceiveE11TrackerTypeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEm
//    void send(long, std::string const&, unsigned long); //TODO: incomplete function definition // _ZN19NetworkDebugManager4sendE11TrackerTypeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEm
//    void receive(long, std::string const&, unsigned long); //TODO: incomplete function definition // _ZN19NetworkDebugManager7receiveE11TrackerTypeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEm
    void update(); // _ZN19NetworkDebugManager6updateEv
//    void getStats(long)const; //TODO: incomplete function definition // _ZNK19NetworkDebugManager8getStatsE11TrackerType
//    void getGraphBars(long)const; //TODO: incomplete function definition // _ZNK19NetworkDebugManager12getGraphBarsE11TrackerType
