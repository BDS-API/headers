...
//    Ability(bool, long); //TODO: incomplete function definition // _ZN7AbilityC2EbNS_7OptionsE
//    Ability(float, long); //TODO: incomplete function definition // _ZN7AbilityC2EfNS_7OptionsE
...
//    void reset(long); //TODO: incomplete function definition // _ZN7Ability5resetENS_4TypeE
    void getFloat()const; // _ZNK7Ability8getFloatEv
    void setFloat(float); // _ZN7Ability8setFloatEf
//    bool hasOption(long)const; //TODO: incomplete function definition // _ZNK7Ability9hasOptionENS_7OptionsE
    class Value {
