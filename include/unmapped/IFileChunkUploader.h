...
public:
    virtual ~IFileChunkUploader(); // _ZN18IFileChunkUploaderD2Ev
    ...
    virtual void uploadStream(FileInfo const&, unsigned long, std::string const&, std::function<bool (unsigned long &, std::vector<unsigned char> &)>, std::function<void (long)>); // _ZN18IFileChunkUploader12uploadStreamERK8FileInfomRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt8functionIFbRmRSt6vectorIhSaIhEEEESB_IFvNS_18UploadStreamResultEEE
