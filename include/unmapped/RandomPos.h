...
//    void getPos(Vec3 &, Mob &, int, int, int, long); //TODO: incomplete function definition // _ZN9RandomPos6getPosER4Vec3R3Mobiii17SolidityCheckType
//    void generateRandomPos(Vec3 &, Mob &, int, int, Vec3 *, bool, bool, int, long); //TODO: incomplete function definition // _ZN9RandomPos17generateRandomPosER4Vec3R3MobiiPS0_bbi17SolidityCheckType
    void getPosTowards(Vec3 &, Mob &, int, int, Vec3 const&); // _ZN9RandomPos13getPosTowardsER4Vec3R3MobiiRKS0_
//    void getPosInDirection(Vec3 &, Mob &, int, int, int, bool, bool, Vec3 *, IntRange const&, int, long); //TODO: incomplete function definition // _ZN9RandomPos17getPosInDirectionER4Vec3R3MobiiibbPS0_RK8IntRangei17SolidityCheckType
//    void generateRandomPos(Vec3 &, Mob &, int, int, int, Vec3 *, bool, bool, IntRange const&, int, long); //TODO: incomplete function definition // _ZN9RandomPos17generateRandomPosER4Vec3R3MobiiiPS0_bbRK8IntRangei17SolidityCheckType
...
//    void snapToGround(BlockPos &, Mob &, int, IntRange const&, long); //TODO: incomplete function definition // _ZN9RandomPos12snapToGroundER8BlockPosR3MobiRK8IntRange17SolidityCheckType
