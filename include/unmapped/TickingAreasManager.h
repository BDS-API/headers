...
public:
    ...
    TickingAreasManager(std::unordered_map<long, std::unique_ptr<Dimension>, std::hash<long>, long, std::allocator<std::pair<long const, std::unique_ptr<Dimension>>>> &); // _ZN19TickingAreasManagerC2ERSt13unordered_mapI11AutomaticIDI9DimensioniESt10unique_ptrIS2_St14default_deleteIS2_EESt4hashIS3_ESt8equal_toIS3_ESaISt4pairIKS3_S7_EEE
...
//    void _savePendingArea(LevelStorage &, long, PendingArea const&); //TODO: incomplete function definition // _ZN19TickingAreasManager16_savePendingAreaER12LevelStorage11AutomaticIDI9DimensioniERK11PendingArea
