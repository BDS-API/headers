...
public:
    virtual ~DanceComponentListener(); // _ZN22DanceComponentListenerD2Ev
    virtual void __fake_function0(); // fake
    virtual void levelSoundEvent__incomplete0(long, Vec3 const&, int, ActorDefinitionIdentifier const&, bool, bool); //TODO: incomplete function definition // _ZN22DanceComponentListener15levelSoundEventE15LevelSoundEventRK4Vec3iRK25ActorDefinitionIdentifierbb
