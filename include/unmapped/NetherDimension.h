...
public:
    virtual ~NetherDimension(); // _ZN15NetherDimensionD2Ev
    ...
    virtual void translatePosAcrossDimension__incomplete0(Vec3 const&, long)const; //TODO: incomplete function definition // _ZNK15NetherDimension27translatePosAcrossDimensionERK4Vec311AutomaticIDI9DimensioniE
