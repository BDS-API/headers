...
//    std::string findLastColorCode(long, bool); //TODO: incomplete function definition // _ZN4Util17findLastColorCodeB5cxx11EN3gsl17basic_string_spanIKcLln1EEEb
//    void span_find(long, long); //TODO: incomplete function definition // _ZN4Util9span_findEN3gsl17basic_string_spanIKcLln1EEES3_
...
//    std::string caseFold(long); //TODO: incomplete function definition // _ZN4Util8caseFoldB5cxx11EN3gsl17basic_string_spanIKcLln1EEE
...
//    void countWordOccurrences(long, long); //TODO: incomplete function definition // _ZN4Util20countWordOccurrencesEN3gsl17basic_string_spanIKcLln1EEES3_
//    bool isValidPath(long); //TODO: incomplete function definition // _ZN4Util11isValidPathEN3gsl17basic_string_spanIKcLln1EEE
...
//    bool isValidIPv4(long); //TODO: incomplete function definition // _ZN4Util11isValidIPv4EN3gsl17basic_string_spanIKcLln1EEE
//    bool isValidIPv6(long); //TODO: incomplete function definition // _ZN4Util11isValidIPv6EN3gsl17basic_string_spanIKcLln1EEE
...
//    bool isValidIP(long, bool, bool); //TODO: incomplete function definition // _ZN4Util9isValidIPEN3gsl17basic_string_spanIKcLln1EEEbb
    ...
    void _recordProfanityLocationInWord(std::string const&, std::string &, std::vector<std::pair<int, int>> const&, int, int, std::set<std::pair<int, int>, long, std::allocator<std::pair<int, int>>> &, std::unordered_map<std::string, int, std::hash<std::string>, long, std::allocator<std::pair<std::string const, int>>> const&, std::unordered_set<std::string, std::hash<std::string>, long, std::allocator<std::string>> const&); // _ZN4Util30_recordProfanityLocationInWordERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERS5_RKSt6vectorISt4pairIiiESaISB_EEiiRSt3setISB_St4lessISB_ESC_ERKSt13unordered_mapIS5_iSt4hashIS5_ESt8equal_toIS5_ESaISA_IS6_iEEERKSt13unordered_setIS5_SN_SP_SaIS5_EE
//    void _breakIntoWordsAndFindProfanity(std::string &, std::string &, std::vector<std::pair<int, int>> const&, std::unordered_set<char, std::hash<char>, long, std::allocator<char>> const&, std::set<std::pair<int, int>, long, std::allocator<std::pair<int, int>>> &, std::unordered_map<std::string, int, std::hash<std::string>, long, std::allocator<std::pair<std::string const, int>>> const&, std::unordered_set const&, std::hash<std::string>, long, std::allocator<std::string>); //TODO: incomplete function definition // _ZN4Util31_breakIntoWordsAndFindProfanityERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES6_RKSt6vectorISt4pairIiiESaIS9_EERKSt13unordered_setIcSt4hashIcESt8equal_toIcES4_ERSt3setIS9_St4lessIS9_ESA_ERKSt13unordered_mapIS5_iSF_IS5_ESH_IS5_ESaIS8_IKS5_iEEERKSE_IS5_SS_ST_SaIS5_EE
    void filterProfanityFromString(std::string const&, std::unordered_map<std::string, int, std::hash<std::string>, long, std::allocator<std::pair<std::string const, int>>> const&, std::unordered_set<std::string, std::hash<std::string>, long, std::allocator<std::string>> const&); // _ZN4Util25filterProfanityFromStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKSt13unordered_mapIS5_iSt4hashIS5_ESt8equal_toIS5_ESaISt4pairIS6_iEEERKSt13unordered_setIS5_SA_SC_SaIS5_EE
...
//    void toString(long); //TODO: incomplete function definition // _ZN4Util8toStringE17BoneTransformType
...
//    void convertCapabilitiesStringToEnum(long); //TODO: incomplete function definition // _ZN4Util31convertCapabilitiesStringToEnumEN3gsl17basic_string_spanIKcLln1EEE
...
//    void toString(long const&); //TODO: incomplete function definition // _ZN4Util8toStringERKNSt7__cxx1112basic_stringIwSt11char_traitsIwESaIwEEE
...
//    void compareNoCase(long, long); //TODO: incomplete function definition // _ZN4Util13compareNoCaseEN3gsl17basic_string_spanIKcLln1EEES3_
...
//    void stringReplace(std::string, long); //TODO: incomplete function definition // _ZN4Util13stringReplaceENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE11buffer_spanISt4pairIN3gsl17basic_string_spanIKcLln1EEESB_EE
...
//    std::string toLower(long const&); //TODO: incomplete function definition // _ZN4Util7toLowerB5cxx11ERKN3gsl17basic_string_spanIKcLln1EEE
//    std::string toUpper(long const&); //TODO: incomplete function definition // _ZN4Util7toUpperB5cxx11ERKN3gsl17basic_string_spanIKcLln1EEE
...
//    std::string format(char const*, long); //TODO: incomplete function definition // _ZN4Util6formatB5cxx11EPKcz
//    std::string vFormat(char const*, long *); //TODO: incomplete function definition // _ZN4Util7vFormatB5cxx11EPKcP13__va_list_tag
...
//    bool startsWith(long, long); //TODO: incomplete function definition // _ZN4Util10startsWithEN3gsl17basic_string_spanIKcLln1EEES3_
...
//    void stringUTF16ToUTF8(long const&); //TODO: incomplete function definition // _ZN4Util17stringUTF16ToUTF8ERKNSt7__cxx1112basic_stringIwSt11char_traitsIwESaIwEEE
...
//    bool endsWith(long, long); //TODO: incomplete function definition // _ZN4Util8endsWithEN3gsl17basic_string_spanIKcLln1EEES3_
...
//    void split(std::string const&, std::vector<std::string> const&, bool, bool, std::istream & (long &, std::string &), long); //TODO: incomplete function definition // _ZN4Util5splitERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKSt6vectorIS5_SaIS5_EEbbPFRSiSD_RS5_E
//    void splitLines(std::string const&, std::istream & (long &, std::string &), long); //TODO: incomplete function definition // _ZN4Util10splitLinesERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEPFRSiS8_RS5_E
