...
public:
    virtual ~PlayerEventListener(); // _ZN19PlayerEventListenerD2Ev
    virtual void __fake_function0(); // fake
    virtual void onPlayerAwardAchievement__incomplete0(Player &, long); //TODO: incomplete function definition // _ZN19PlayerEventListener24onPlayerAwardAchievementER6PlayerN17MinecraftEventing14AchievementIdsE
    virtual void onPlayerPortalBuilt__incomplete0(Player &, long); //TODO: incomplete function definition // _ZN19PlayerEventListener19onPlayerPortalBuiltER6Player11AutomaticIDI9DimensioniE
    virtual void onPlayerPortalUsed__incomplete0(Player &, long, long); //TODO: incomplete function definition // _ZN19PlayerEventListener18onPlayerPortalUsedER6Player11AutomaticIDI9DimensioniES4_
    ...
    virtual void onPlayerAction__incomplete0(Player &, long, BlockPos const&, int); //TODO: incomplete function definition // _ZN19PlayerEventListener14onPlayerActionER6Player16PlayerActionTypeRK8BlockPosi
    virtual void onPlayerHurt(Player &, ActorDamageSource &); // _ZN19PlayerEventListener12onPlayerHurtER6PlayerR17ActorDamageSource
    virtual void onLocalPlayerDeath__incomplete0(long &, long &); //TODO: incomplete function definition // _ZN19PlayerEventListener18onLocalPlayerDeathER15IClientInstanceR11LocalPlayer
    virtual void onLocalPlayerRespawn__incomplete0(long &, long &); //TODO: incomplete function definition // _ZN19PlayerEventListener20onLocalPlayerRespawnER15IClientInstanceR11LocalPlayer
    ...
    virtual void onPlayerCreated__incomplete0(long &, std::string const&, std::string const&, bool); //TODO: incomplete function definition // _ZN19PlayerEventListener15onPlayerCreatedER11LocalPlayerRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES9_b
