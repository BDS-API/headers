...
public:
    virtual ~LargeCaveFeature(); // _ZN16LargeCaveFeatureD2Ev
...
//    void _thinSand(long, short, int)const; //TODO: incomplete function definition // _ZNK16LargeCaveFeature9_thinSandE11buffer_spanIPK5BlockEsi
