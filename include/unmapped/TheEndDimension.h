...
public:
    ...
    virtual ~TheEndDimension(); // _ZN15TheEndDimensionD2Ev
    ...
    virtual void translatePosAcrossDimension__incomplete0(Vec3 const&, long)const; //TODO: incomplete function definition // _ZNK15TheEndDimension27translatePosAcrossDimensionERK4Vec311AutomaticIDI9DimensioniE
