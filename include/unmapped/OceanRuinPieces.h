...
//    void _addClusterRuins(StructureManager &, Random &, long const&, BlockPos const&, long const&, std::vector<std::unique_ptr<StructurePiece>> &); //TODO: incomplete function definition // _ZN15OceanRuinPieces16_addClusterRuinsER16StructureManagerR6RandomRK8RotationRK8BlockPosRK22OceanRuinConfigurationRSt6vectorISt10unique_ptrI14StructurePieceSt14default_deleteISF_EESaISI_EE
    void _allPositions(Random &, int, int, int); // _ZN15OceanRuinPieces13_allPositionsER6Randomiii
//    void _addPiece(StructureManager &, BlockPos const&, long const&, std::vector<std::unique_ptr<StructurePiece>> &, Random &, long const&, bool, float); //TODO: incomplete function definition // _ZN15OceanRuinPieces9_addPieceER16StructureManagerRK8BlockPosRK8RotationRSt6vectorISt10unique_ptrI14StructurePieceSt14default_deleteISA_EESaISD_EER6RandomRK22OceanRuinConfigurationbf
    void init(); // _ZN15OceanRuinPieces4initEv
//    void addPieces(StructureManager &, BlockPos const&, long const&, std::vector<std::unique_ptr<StructurePiece>> &, Random &, long const&); //TODO: incomplete function definition // _ZN15OceanRuinPieces9addPiecesER16StructureManagerRK8BlockPosRK8RotationRSt6vectorISt10unique_ptrI14StructurePieceSt14default_deleteISA_EESaISD_EER6RandomRK22OceanRuinConfiguration
};
