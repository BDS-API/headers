...
namespace BedrockEngine {
    ...
    public:
        virtual ~AppIsland(); // _ZN13BedrockEngine9AppIslandD2Ev
        ...
        virtual bool processActivationArguments__incomplete0(long const&); //TODO: incomplete function definition // _ZN13BedrockEngine9AppIsland26processActivationArgumentsERK19ActivationArguments
