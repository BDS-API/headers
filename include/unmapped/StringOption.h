...
public:
    virtual ~StringOption(); // _ZN12StringOptionD2Ev
...
//    StringOption(long, long, long, std::string const&, std::string const&, std::string const&); //TODO: incomplete function definition // _ZN12StringOptionC2E8OptionID15OptionOwnerType16OptionResetFlagsRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESA_SA_
