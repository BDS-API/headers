...
public:
    virtual ~SpawnGroupRegistry(); // _ZN18SpawnGroupRegistryD2Ev
    ...
    virtual void readResourceFiles(ResourcePackManager &, std::unordered_map<std::string, std::string, std::hash<std::string>, long, std::allocator<std::pair<std::string const, std::string>>> &); // _ZN18SpawnGroupRegistry17readResourceFilesER19ResourcePackManagerRSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES8_St4hashIS8_ESt8equal_toIS8_ESaISt4pairIKS8_S8_EEE
