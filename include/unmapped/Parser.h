...
//    void parse(Json::Value const&, long &, char const*, char const*); //TODO: incomplete function definition // _ZN6Parser5parseERKN4Json5ValueER12ParticleTypePKcS7_
//    void parse(Json::Value const&, long &, char const*, char const*); //TODO: incomplete function definition // _ZN6Parser5parseERKN4Json5ValueER10DifficultyPKcS7_
...
//    void parse(Json::Value const&, long &, char const*, char const*); //TODO: incomplete function definition // _ZN6Parser5parseERKN4Json5ValueER16ActorDamageCausePKcS7_
...
//    void parse(Json::Value const&, long &, char const*, char const*); //TODO: incomplete function definition // _ZN6Parser5parseERKN4Json5ValueER9ActorTypePKcS7_
    void parse(Json::Value const&, Json::Value &, char const*); // _ZN6Parser5parseERKN4Json5ValueERS1_PKc
    void parse(Json::Value const&, std::set<Item const*, long, std::allocator<Item const*>> &, char const*); // _ZN6Parser5parseERKN4Json5ValueERSt3setIPK4ItemSt4lessIS7_ESaIS7_EEPKc
    void parse(Json::Value const&, std::set<Block const*, long, std::allocator<Block const*>> &, char const*); // _ZN6Parser5parseERKN4Json5ValueERSt3setIPK5BlockSt4lessIS7_ESaIS7_EEPKc
    void parse(Json::Value const&, std::set<std::string, long, std::allocator<std::string>> &, char const*); // _ZN6Parser5parseERKN4Json5ValueERSt3setINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4lessISA_ESaISA_EEPKc
    ...
    void parse(Json::Value const&, std::vector<long> &, char const*, char const*); // _ZN6Parser5parseERKN4Json5ValueERSt6vectorI15LevelSoundEventSaIS5_EEPKcSA_
...
//    void parse(Json::Value &, long &, char const*); //TODO: incomplete function definition // _ZN6Parser5parseERN4Json5ValueER15WeightedChoicesI17DefinitionTriggerEPKc
...
//    void serialize(long const&, Json::Value &, char const*); //TODO: incomplete function definition // _ZN6Parser9serializeERK12ParticleTypeRN4Json5ValueEPKc
//    void serialize(long const&, Json::Value &, char const*); //TODO: incomplete function definition // _ZN6Parser9serializeERK10DifficultyRN4Json5ValueEPKc
    void serialize(Util::HashString const&, Json::Value &, char const*); // _ZN6Parser9serializeERKN4Util10HashStringERN4Json5ValueEPKc
//    void serialize(long const&, Json::Value &, char const*); //TODO: incomplete function definition // _ZN6Parser9serializeERK16ActorDamageCauseRN4Json5ValueEPKc
...
//    void serialize(long const&, Json::Value &, char const*); //TODO: incomplete function definition // _ZN6Parser9serializeERK9ActorTypeRN4Json5ValueEPKc
    void serialize(std::set<Item const*, long, std::allocator<Item const*>> const&, Json::Value &, char const*); // _ZN6Parser9serializeERKSt3setIPK4ItemSt4lessIS3_ESaIS3_EERN4Json5ValueEPKc
    void serialize(std::set<Block const*, long, std::allocator<Block const*>> const&, Json::Value &, char const*); // _ZN6Parser9serializeERKSt3setIPK5BlockSt4lessIS3_ESaIS3_EERN4Json5ValueEPKc
    void serialize(std::set<std::string, long, std::allocator<std::string>> const&, Json::Value &, char const*); // _ZN6Parser9serializeERKSt3setINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4lessIS6_ESaIS6_EERN4Json5ValueEPKc
    ...
    void serialize(std::vector<long> const&, Json::Value &, char const*); // _ZN6Parser9serializeERKSt6vectorI15LevelSoundEventSaIS1_EERN4Json5ValueEPKc
