...
public:
    virtual ~TaskGroup(); // _ZN9TaskGroupD2Ev
    ...
    virtual void taskComplete__incomplete0(long); //TODO: incomplete function definition // _ZN9TaskGroup12taskCompleteEN3gsl8not_nullIP14BackgroundTaskEE
    void getCurrentTaskGroup(); // _ZN9TaskGroup19getCurrentTaskGroupEv
//    void queueChild(long, std::function<TaskResult (void)> &&, std::function<void (void)> &&); //TODO: incomplete function definition // _ZN9TaskGroup10queueChildEN3gsl17basic_string_spanIKcLln1EEEOSt8functionIF10TaskResultvEEOS4_IFvvEE
...
//    void queueChildSync(long, std::function<TaskResult (void)> &&); //TODO: incomplete function definition // _ZN9TaskGroup14queueChildSyncEN3gsl17basic_string_spanIKcLln1EEEOSt8functionIF10TaskResultvEE
...
//    TaskGroup(WorkerPool &, Scheduler &, std::string, long); //TODO: incomplete function definition // _ZN9TaskGroupC2ER10WorkerPoolR9SchedulerNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE8TaskType
    void flush(std::function<void (void)>); // _ZN9TaskGroup5flushESt8functionIFvvEE
//    void queue(long, std::function<TaskResult (void)> &&, std::function<void (void)> &&); //TODO: incomplete function definition // _ZN9TaskGroup5queueEN3gsl17basic_string_spanIKcLln1EEEOSt8functionIF10TaskResultvEEOS4_IFvvEE
    void _queueInternal(std::shared_ptr<BackgroundTask>); // _ZN9TaskGroup14_queueInternalESt10shared_ptrI14BackgroundTaskE
//    void queueSync(long, std::function<TaskResult (void)> &&); //TODO: incomplete function definition // _ZN9TaskGroup9queueSyncEN3gsl17basic_string_spanIKcLln1EEEOSt8functionIF10TaskResultvEE
