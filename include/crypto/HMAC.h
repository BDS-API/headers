...
//            HMAC(long, std::string const&, int); //TODO: incomplete function definition // ._ZN6Crypto4Hash4HMACC1ENS0_8HashTypeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEi
        };
    }
}
