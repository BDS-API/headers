...
public:
    virtual ~StrongholdPiece(); // _ZN15StrongholdPieceD2Ev
...
//    void generateSmallDoor(BlockSource *, Random &, BoundingBox const&, long, int, int, int); //TODO: incomplete function definition // _ZN15StrongholdPiece17generateSmallDoorEP11BlockSourceR6RandomRK11BoundingBoxNS_13SmallDoorTypeEiii
