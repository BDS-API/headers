...
namespace PillagerOutpostPieces {
    ...
    public:
        virtual ~PillagerOutpostPiece(); // _ZN21PillagerOutpostPieces20PillagerOutpostPieceD2Ev
...
//        PillagerOutpostPiece(StructureManager &, std::string, BlockPos const&, long, float, bool, Dimension &); //TODO: incomplete function definition // _ZN21PillagerOutpostPieces20PillagerOutpostPieceC2ER16StructureManagerNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERK8BlockPos8RotationfbR9Dimension
