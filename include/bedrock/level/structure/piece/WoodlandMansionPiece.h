...
namespace WoodlandMansionPieces {
    ...
    public:
        virtual ~WoodlandMansionPiece(); // _ZN21WoodlandMansionPieces20WoodlandMansionPieceD2Ev
...
//        WoodlandMansionPiece(StructureManager &, std::string const&, BlockPos const&, long); //TODO: incomplete function definition // _ZN21WoodlandMansionPieces20WoodlandMansionPieceC2ER16StructureManagerRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERK8BlockPos8Rotation
//        WoodlandMansionPiece(StructureManager &, std::string const&, BlockPos const&, long, long); //TODO: incomplete function definition // _ZN21WoodlandMansionPieces20WoodlandMansionPieceC2ER16StructureManagerRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERK8BlockPos8Rotation6Mirror
