...
public:
    virtual ~ServerLevel(); // _ZN11ServerLevelD2Ev
    ...
    virtual void setDifficulty__incomplete0(long); //TODO: incomplete function definition // _ZN11ServerLevel13setDifficultyE10Difficulty
    ...
    virtual void runCommand__incomplete0(HashedString const&, CommandOrigin &, long, long); //TODO: incomplete function definition // _ZN11ServerLevel10runCommandERK12HashedStringR13CommandOrigin19CommandOriginSystem17CurrentCmdVersion
    ...
    bool shouldSendSleepMessage()const; // _ZNK11ServerLevel22shouldSendSleepMessageEv
