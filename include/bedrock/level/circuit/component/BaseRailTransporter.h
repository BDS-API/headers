...
public:
    virtual ~BaseRailTransporter(); // _ZN19BaseRailTransporterD2Ev
...
//    void setType(long); //TODO: incomplete function definition // _ZN19BaseRailTransporter7setTypeENS_8RailTypeE
