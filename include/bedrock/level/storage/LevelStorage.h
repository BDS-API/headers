...
public:
    ...
    virtual ~LevelStorage(); // _ZN12LevelStorageD2Ev
    virtual void __fake_function0(); // fake
    virtual void createWriteBatch(); // _ZN12LevelStorage16createWriteBatchEv
    virtual void clonePlayerData__incomplete0(long, long); //TODO: incomplete function definition // _ZN12LevelStorage15clonePlayerDataEN3gsl17basic_string_spanIKcLln1EEES3_
    virtual void loadData__incomplete0(long, std::string &)const; //TODO: incomplete function definition // _ZNK12LevelStorage8loadDataEN3gsl17basic_string_spanIKcLln1EEERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
...
//    void loadPlayerDataFromTag(long); //TODO: incomplete function definition // _ZN12LevelStorage21loadPlayerDataFromTagEN3gsl17basic_string_spanIKcLln1EEE
    ...
    public:
        virtual ~Batch(); // _ZN12LevelStorage5BatchD2Ev
        virtual void __fake_function0(); // fake
