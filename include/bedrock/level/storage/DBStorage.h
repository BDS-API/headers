...
public:
    ...
    virtual ~DBStorage(); // _ZN9DBStorageD2Ev
    ...
    virtual bool hasKey__incomplete0(long)const; //TODO: incomplete function definition // _ZNK9DBStorage6hasKeyEN3gsl17basic_string_spanIKcLln1EEE
    virtual void forEachKeyWithPrefix__incomplete0(long, std::function<void (long, long)> const&)const; //TODO: incomplete function definition // _ZNK9DBStorage20forEachKeyWithPrefixEN3gsl17basic_string_spanIKcLln1EEERKSt8functionIFvS3_S3_EE
    virtual void loadLevelData(LevelData &); // _ZN9DBStorage13loadLevelDataER9LevelData
    virtual void createChunkStorage__incomplete0(std::unique_ptr<ChunkSource>, long); //TODO: incomplete function definition // _ZN9DBStorage18createChunkStorageESt10unique_ptrI11ChunkSourceSt14default_deleteIS1_EE14StorageVersion
    ...
    virtual void loadData__incomplete0(long, std::string &)const; //TODO: incomplete function definition // _ZNK9DBStorage8loadDataEN3gsl17basic_string_spanIKcLln1EEERNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
    ...
    virtual void setCompactionCallback(std::function<void (long)>); // _ZN9DBStorage21setCompactionCallbackESt8functionIFv16CompactionStatusEE
    ...
    virtual void _saveDataSync__incomplete0(long, std::string &&); //TODO: incomplete function definition // _ZN9DBStorage13_saveDataSyncEN3gsl17basic_string_spanIKcLln1EEEONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
...
//    std::string _getTelemetryMessage(long const&)const; //TODO: incomplete function definition // _ZNK9DBStorage20_getTelemetryMessageB5cxx11ERKN7leveldb6StatusE
...
//    void _write(long, long); //TODO: incomplete function definition // _ZN9DBStorage6_writeEN3gsl17basic_string_spanIKcLln1EEES3_
//    void _read(long, std::function<void (long, long)> const&)const; //TODO: incomplete function definition // _ZNK9DBStorage5_readEN3gsl17basic_string_spanIKcLln1EEERKSt8functionIFvS3_S3_EE
...
//    void _markAsCorrupted(long)const; //TODO: incomplete function definition // _ZNK9DBStorage16_markAsCorruptedEN3gsl17basic_string_spanIKcLln1EEE
//    void _handleErrorStatus(long const&); //TODO: incomplete function definition // _ZN9DBStorage18_handleErrorStatusERKN7leveldb6StatusE
//    void _write(long &); //TODO: incomplete function definition // _ZN9DBStorage6_writeERN7leveldb10WriteBatchE
//    bool hasAnyKeyWithPrefix(long const&)const; //TODO: incomplete function definition // _ZNK9DBStorage19hasAnyKeyWithPrefixERKN7leveldb5SliceE
