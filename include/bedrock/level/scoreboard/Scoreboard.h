...
public:
    ...
    virtual ~Scoreboard(); // _ZN10ScoreboardD2Ev
    virtual void __fake_function0(); // fake
    virtual void setDisplayObjective__incomplete0(std::string const&, Objective const&, long); //TODO: incomplete function definition // _ZN10Scoreboard19setDisplayObjectiveERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERK9Objective18ObjectiveSortOrder
...
//    void createObjectiveCriteria(std::string const&, bool, long); //TODO: incomplete function definition // _ZN10Scoreboard23createObjectiveCriteriaERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEb19ObjectiveRenderType
    ...
    bool shouldUpdateUI()const; // _ZNK10Scoreboard14shouldUpdateUIEv
    void onUpdateUI(); // _ZN10Scoreboard10onUpdateUIEv
//    void modifyPlayerScore(bool &, ScoreboardId const&, Objective &, int, long); //TODO: incomplete function definition // _ZN10Scoreboard17modifyPlayerScoreERbRK12ScoreboardIdR9Objectivei22PlayerScoreSetFunction
    void getScoreboardIdentityRef(ScoreboardId const&); // _ZN10Scoreboard24getScoreboardIdentityRefERK12ScoreboardId
    void getDisplayInfoSorted(std::string const&, std::function<void (long, std::vector<PlayerScore> &)>)const; // _ZNK10Scoreboard20getDisplayInfoSortedERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt8functionIFv18ObjectiveSortOrderRSt6vectorI11PlayerScoreSaISB_EEEE
...
//    void applyPlayerOperation(bool &, std::vector<ScoreboardId> &, ScoreboardId const&, Objective &, std::vector<ScoreboardId> &, Objective &, long); //TODO: incomplete function definition // _ZN10Scoreboard20applyPlayerOperationERbRSt6vectorI12ScoreboardIdSaIS2_EERKS2_R9ObjectiveS5_S9_15CommandOperator
//    void _processOperation(bool &, long, int, int); //TODO: incomplete function definition // _ZN10Scoreboard17_processOperationERb15CommandOperatorii
    ...
    bool shouldClearScoresOnDeath(Actor const&); // _ZN10Scoreboard24shouldClearScoresOnDeathERK5Actor
