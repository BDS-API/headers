...
public:
    virtual ~UpdateEquipPacket(); // _ZN17UpdateEquipPacketD2Ev
...
//    UpdateEquipPacket(long, long, int, CompoundTag &&, ActorUniqueID const&); //TODO: incomplete function definition // _ZN17UpdateEquipPacketC2E11ContainerID13ContainerTypeiO11CompoundTagRK13ActorUniqueID
};
