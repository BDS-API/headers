...
public:
    virtual ~LevelSoundEventPacketV2(); // _ZN23LevelSoundEventPacketV2D2Ev
...
//    LevelSoundEventPacketV2(long, Vec3 const&, int, std::string const&, bool, bool); //TODO: incomplete function definition // _ZN23LevelSoundEventPacketV2C2E15LevelSoundEventRK4Vec3iRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEbb
