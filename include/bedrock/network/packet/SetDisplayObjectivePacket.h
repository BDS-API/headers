...
public:
    virtual ~SetDisplayObjectivePacket(); // _ZN25SetDisplayObjectivePacketD2Ev
...
//    SetDisplayObjectivePacket(std::string const&, std::string const&, std::string const&, std::string const&, long); //TODO: incomplete function definition // _ZN25SetDisplayObjectivePacketC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES7_S7_S7_18ObjectiveSortOrder
};
