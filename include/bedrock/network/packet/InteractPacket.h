...
public:
    virtual ~InteractPacket(); // _ZN14InteractPacketD2Ev
...
//    InteractPacket(long, ActorRuntimeID, Vec3 const&); //TODO: incomplete function definition // _ZN14InteractPacketC2ENS_6ActionE14ActorRuntimeIDRK4Vec3
};
