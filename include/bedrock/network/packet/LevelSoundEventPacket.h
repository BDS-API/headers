...
public:
    virtual ~LevelSoundEventPacket(); // _ZN21LevelSoundEventPacketD2Ev
...
//    LevelSoundEventPacket(long, Vec3 const&, int, std::string const&, bool, bool); //TODO: incomplete function definition // _ZN21LevelSoundEventPacketC2E15LevelSoundEventRK4Vec3iRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEbb
