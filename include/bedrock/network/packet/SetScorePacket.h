...
public:
    virtual ~SetScorePacket(); // _ZN14SetScorePacketD2Ev
...
//    SetScorePacket(long, ScoreboardId const&, Objective const&); //TODO: incomplete function definition // _ZN14SetScorePacketC2E15ScorePacketTypeRK12ScoreboardIdRK9Objective
