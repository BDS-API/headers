...
public:
    virtual ~UpdateSoftEnumPacket(); // _ZN20UpdateSoftEnumPacketD2Ev
...
//    UpdateSoftEnumPacket(long, std::string const&, std::vector<std::string> const&); //TODO: incomplete function definition // _ZN20UpdateSoftEnumPacketC2E18SoftEnumUpdateTypeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKSt6vectorIS6_SaIS6_EE
