...
public:
    virtual ~UpdateTradePacket(); // _ZN17UpdateTradePacketD2Ev
...
//    UpdateTradePacket(long, long, int, std::string const&, CompoundTag &&, ActorUniqueID const&, ActorUniqueID const, int, bool, bool); //TODO: incomplete function definition // _ZN17UpdateTradePacketC2E11ContainerID13ContainerTypeiRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEO11CompoundTagRK13ActorUniqueIDSE_ibb
};
