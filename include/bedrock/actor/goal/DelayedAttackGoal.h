...
public:
    virtual ~DelayedAttackGoal(); // _ZN17DelayedAttackGoalD2Ev
...
//    DelayedAttackGoal(Mob &, float, bool, float, long, int, float, bool, int, int, long); //TODO: incomplete function definition // _ZN17DelayedAttackGoalC2ER3Mobfbf13ActorCategoryifbii15LevelSoundEvent
