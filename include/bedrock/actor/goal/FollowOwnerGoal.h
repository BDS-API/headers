...
public:
    virtual ~FollowOwnerGoal(); // _ZN15FollowOwnerGoalD2Ev
    ...
    virtual void onPlayerDimensionChanged__incomplete0(Player *, long); //TODO: incomplete function definition // _ZN15FollowOwnerGoal24onPlayerDimensionChangedEP6Player11AutomaticIDI9DimensioniE
