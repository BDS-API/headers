...
public:
    virtual ~RemovedActorDamageByType(); // _ZN24RemovedActorDamageByTypeD2Ev
...
//    RemovedActorDamageByType(long, long); //TODO: incomplete function definition // _ZN24RemovedActorDamageByTypeC2E16ActorDamageCause9ActorType
};
