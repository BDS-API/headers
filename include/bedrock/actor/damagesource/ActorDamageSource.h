...
public:
    virtual ~ActorDamageSource(); // _ZN17ActorDamageSourceD2Ev
...
//    std::string lookupCauseName(long); //TODO: incomplete function definition // _ZN17ActorDamageSource15lookupCauseNameB5cxx11E16ActorDamageCause
    ActorDamageSource(std::string const&); // _ZN17ActorDamageSourceC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE
//    ActorDamageSource(long); //TODO: incomplete function definition // _ZN17ActorDamageSourceC2E16ActorDamageCause
    void getCause()const; // _ZNK17ActorDamageSource8getCauseEv
//    void setCause(long); //TODO: incomplete function definition // _ZN17ActorDamageSource8setCauseE16ActorDamageCause
};
