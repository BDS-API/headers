...
public:
    virtual ~IronGolem(); // _ZN9IronGolemD2Ev
    virtual void __fake_function0(); // fake
    virtual void getShadowRadius()const; // _ZNK9IronGolem15getShadowRadiusEv
    virtual void handleEntityEvent__incomplete0(long, int); //TODO: incomplete function definition // _ZN9IronGolem17handleEntityEventE10ActorEventi
