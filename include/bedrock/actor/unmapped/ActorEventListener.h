...
public:
    virtual ~ActorEventListener(); // _ZN18ActorEventListenerD2Ev
    ...
    virtual void onActorUseItem__incomplete0(Actor &, ItemInstance const&, long); //TODO: incomplete function definition // _ZN18ActorEventListener14onActorUseItemER5ActorRK12ItemInstance13ItemUseMethod
    ...
    virtual void onActorAcquiredItem__incomplete0(Actor &, ItemInstance const&, unsigned int, long, Actor *); //TODO: incomplete function definition // _ZN18ActorEventListener19onActorAcquiredItemER5ActorRK12ItemInstancej21ItemAcquisitionMethodPS0_
    ...
    virtual void onActorCarriedItemChanged__incomplete0(Actor &, ItemInstance const&, ItemInstance const&, long); //TODO: incomplete function definition // _ZN18ActorEventListener25onActorCarriedItemChangedER5ActorRK12ItemInstanceS4_8HandSlot
    virtual void onActorEquippedArmor__incomplete0(Actor &, ItemInstance const&, long); //TODO: incomplete function definition // _ZN18ActorEventListener20onActorEquippedArmorER5ActorRK12ItemInstance9ArmorSlot
    virtual void onActorRemoved(Actor &); // _ZN18ActorEventListener14onActorRemovedER5Actor
    virtual void onActorMobInteraction__incomplete0(Actor &, long, long); //TODO: incomplete function definition // _ZN18ActorEventListener21onActorMobInteractionER5ActorN17MinecraftEventing15InteractionTypeE9ActorType
