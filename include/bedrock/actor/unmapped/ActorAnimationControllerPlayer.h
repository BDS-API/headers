...
public:
    virtual ~ActorAnimationControllerPlayer(); // _ZN30ActorAnimationControllerPlayerD2Ev
    virtual void __fake_function0(); // fake
    virtual void applyToPose(RenderParams &, std::unordered_map<long, std::vector<BoneOrientation>, std::hash<long>, long, std::allocator<std::pair<long const, std::vector<BoneOrientation>>>> &, float); // _ZN30ActorAnimationControllerPlayer11applyToPoseER12RenderParamsRSt13unordered_mapI22SkeletalHierarchyIndexSt6vectorI15BoneOrientationSaIS5_EESt4hashIS3_ESt8equal_toIS3_ESaISt4pairIKS3_S7_EEEf
    virtual void resetAnimation(); // _ZN30ActorAnimationControllerPlayer14resetAnimationEv
    virtual void bindParticleEffects(std::unordered_map<StringKey, long, std::hash<StringKey>, long, std::allocator<std::pair<StringKey const, long>>> const&); // _ZN30ActorAnimationControllerPlayer19bindParticleEffectsERKSt13unordered_mapI9StringKey17ParticleEffectPtrSt4hashIS1_ESt8equal_toIS1_ESaISt4pairIKS1_S2_EEE
    virtual void bindSoundEffects(std::unordered_map<StringKey, std::string, std::hash<StringKey>, long, std::allocator<std::pair<StringKey const, std::string>>> const&); // _ZN30ActorAnimationControllerPlayer16bindSoundEffectsERKSt13unordered_mapI9StringKeyNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4hashIS1_ESt8equal_toIS1_ESaISt4pairIKS1_S7_EEE
    ...
    void applyStateAnimationToPose(RenderParams &, std::unordered_map<long, std::vector<BoneOrientation>, std::hash<long>, long, std::allocator<std::pair<long const, std::vector<BoneOrientation>>>> &, float); // _ZN30ActorAnimationControllerPlayer25applyStateAnimationToPoseER12RenderParamsRSt13unordered_mapI22SkeletalHierarchyIndexSt6vectorI15BoneOrientationSaIS5_EESt4hashIS3_ESt8equal_toIS3_ESaISt4pairIKS3_S7_EEEf
    void blendViaShortestPath(std::unordered_map<long, std::vector<BoneOrientation>, std::hash<long>, long, std::allocator<std::pair<long const, std::vector<BoneOrientation>>>> &, std::unordered_map<long, std::vector<BoneOrientation>, std::hash<long>, long, std::allocator<std::pair<long const, std::vector<BoneOrientation>>>> &, std::unordered_map<long, std::vector<BoneOrientation>, std::hash<long>, long, std::allocator<std::pair<long const, std::vector<BoneOrientation>>>> &, float, float); // _ZN30ActorAnimationControllerPlayer20blendViaShortestPathERSt13unordered_mapI22SkeletalHierarchyIndexSt6vectorI15BoneOrientationSaIS3_EESt4hashIS1_ESt8equal_toIS1_ESaISt4pairIKS1_S5_EEESF_SF_ff
};
