...
public:
    virtual ~ActorSpawnRuleBase(); // _ZN18ActorSpawnRuleBaseD2Ev
    ...
    void _readJsonHeader(std::string &&, std::unordered_map<std::string, std::string, std::hash<std::string>, long, std::allocator<std::pair<std::string const, std::string>>> &); // _ZN18ActorSpawnRuleBase15_readJsonHeaderEONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERSt13unordered_mapIS5_S5_St4hashIS5_ESt8equal_toIS5_ESaISt4pairIKS5_S5_EEE
