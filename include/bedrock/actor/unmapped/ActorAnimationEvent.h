...
//    ActorAnimationEvent(float, std::string const&, long); //TODO: incomplete function definition // _ZN19ActorAnimationEventC2EfRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE17CurrentCmdVersion
