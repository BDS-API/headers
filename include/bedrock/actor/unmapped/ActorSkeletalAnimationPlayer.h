...
public:
    virtual ~ActorSkeletalAnimationPlayer(); // _ZN28ActorSkeletalAnimationPlayerD2Ev
    virtual void __fake_function0(); // fake
    virtual void applyToPose(RenderParams &, std::unordered_map<long, std::vector<BoneOrientation>, std::hash<long>, long, std::allocator<std::pair<long const, std::vector<BoneOrientation>>>> &, float); // _ZN28ActorSkeletalAnimationPlayer11applyToPoseER12RenderParamsRSt13unordered_mapI22SkeletalHierarchyIndexSt6vectorI15BoneOrientationSaIS5_EESt4hashIS3_ESt8equal_toIS3_ESaISt4pairIKS3_S7_EEEf
    ...
    virtual void bindParticleEffects(std::unordered_map<StringKey, long, std::hash<StringKey>, long, std::allocator<std::pair<StringKey const, long>>> const&); // _ZN28ActorSkeletalAnimationPlayer19bindParticleEffectsERKSt13unordered_mapI9StringKey17ParticleEffectPtrSt4hashIS1_ESt8equal_toIS1_ESaISt4pairIKS1_S2_EEE
    virtual void bindSoundEffects(std::unordered_map<StringKey, std::string, std::hash<StringKey>, long, std::allocator<std::pair<StringKey const, std::string>>> const&); // _ZN28ActorSkeletalAnimationPlayer16bindSoundEffectsERKSt13unordered_mapI9StringKeyNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4hashIS1_ESt8equal_toIS1_ESaISt4pairIKS1_S7_EEE
