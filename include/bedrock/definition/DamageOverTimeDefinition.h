...
namespace DamageOverTimeDefinition {
    ...
    void buildSchema(std::shared_ptr<long> &); // _ZN24DamageOverTimeDefinition11buildSchemaERSt10shared_ptrIN8JsonUtil20JsonSchemaObjectNodeINS1_10EmptyClassES_EEE
