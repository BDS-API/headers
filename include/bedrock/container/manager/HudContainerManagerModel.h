...
public:
    virtual ~HudContainerManagerModel(); // _ZN24HudContainerManagerModelD2Ev
...
//    HudContainerManagerModel(long, Player &); //TODO: incomplete function definition // _ZN24HudContainerManagerModelC2E11ContainerIDR6Player
