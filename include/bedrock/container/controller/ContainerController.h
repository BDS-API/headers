...
public:
    virtual ~ContainerController(); // _ZN19ContainerControllerD2Ev
    ...
    bool shouldDrop()const; // _ZNK19ContainerController10shouldDropEv
//    void setItem(int, ContainerItemStack &, long, bool); //TODO: incomplete function definition // _ZN19ContainerController7setItemEiR18ContainerItemStack13ItemPlaceTypeb
...
//    void removeItem(int, long); //TODO: incomplete function definition // _ZN19ContainerController10removeItemEi12ItemTakeType
//    void _canRemove(int, long)const; //TODO: incomplete function definition // _ZNK19ContainerController10_canRemoveEi12ItemTakeType
    void removeItem(int, int); // _ZN19ContainerController10removeItemEii
//    void addToStack(int, ContainerItemStack, long); //TODO: incomplete function definition // _ZN19ContainerController10addToStackEi18ContainerItemStack12ItemTakeType
