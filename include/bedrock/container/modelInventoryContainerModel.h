...
public:
    ...
    virtual ~InventoryContainerModel(); // _ZN23InventoryContainerModelD2Ev
...
//    InventoryContainerModel(long, int, Player &); //TODO: incomplete function definition // _ZN23InventoryContainerModelC2E17ContainerEnumNameiR6Player
