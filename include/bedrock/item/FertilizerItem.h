...
public:
    virtual ~FertilizerItem(); // _ZN14FertilizerItemD2Ev
...
//    FertilizerItem(std::string const&, int, long); //TODO: incomplete function definition // _ZN14FertilizerItemC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEi14FertilizerType
};
