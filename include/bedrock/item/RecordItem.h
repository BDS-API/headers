...
public:
    virtual ~RecordItem(); // _ZN10RecordItemD2Ev
...
//    RecordItem(std::string const&, int, long); //TODO: incomplete function definition // _ZN10RecordItemC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEi15LevelSoundEvent
