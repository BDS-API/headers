...
public:
    virtual ~PrecompiledCommandOrigin(); // _ZN24PrecompiledCommandOriginD2Ev
    ...
    virtual bool canUseAbility__incomplete0(long)const; //TODO: incomplete function definition // _ZNK24PrecompiledCommandOrigin13canUseAbilityE14AbilitiesIndex
