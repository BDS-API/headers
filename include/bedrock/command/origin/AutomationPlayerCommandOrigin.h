...
public:
    virtual ~AutomationPlayerCommandOrigin(); // _ZN29AutomationPlayerCommandOriginD2Ev
...
//    AutomationPlayerCommandOrigin(ActorUniqueID, Level &, std::string const&, long, NetworkIdentifier const&); //TODO: incomplete function definition // _ZN29AutomationPlayerCommandOriginC2E13ActorUniqueIDR5LevelRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE22CommandPermissionLevelRK17NetworkIdentifier
};
