...
//    void updateSoftEnum(long, std::string const&, std::vector<std::string>); //TODO: incomplete function definition // _ZN23CommandSoftEnumRegistry14updateSoftEnumE18SoftEnumUpdateTypeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt6vectorIS6_SaIS6_EE
