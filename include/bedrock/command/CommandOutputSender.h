...
public:
    virtual ~CommandOutputSender(); // _ZN19CommandOutputSenderD2Ev
    ...
    virtual void registerOutputCallback(std::function<void (long &)> const&); // _ZN19CommandOutputSender22registerOutputCallbackERKSt8functionIFvR19AutomationCmdOutputEE
...
//    void sendToAdmins(CommandOrigin const&, CommandOutput const&, long); //TODO: incomplete function definition // _ZN19CommandOutputSender12sendToAdminsERK13CommandOriginRK13CommandOutput22CommandPermissionLevel
