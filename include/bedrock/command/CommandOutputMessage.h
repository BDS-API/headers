...
//    CommandOutputMessage(long, std::string const&, std::vector<std::string> &&); //TODO: incomplete function definition // _ZN20CommandOutputMessageC2E24CommandOutputMessageTypeRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEOSt6vectorIS6_SaIS6_EE
