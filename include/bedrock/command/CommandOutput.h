...
//    CommandOutput(long); //TODO: incomplete function definition // _ZN13CommandOutputC2E17CommandOutputType
    CommandOutput(CommandOutput const&); // _ZN13CommandOutputC2ERKS_
//    void load(long, int, std::vector<CommandOutputMessage> &&, std::unique_ptr<CommandPropertyBag> &&); //TODO: incomplete function definition // _ZN13CommandOutput4loadE17CommandOutputTypeiOSt6vectorI20CommandOutputMessageSaIS2_EEOSt10unique_ptrI18CommandPropertyBagSt14default_deleteIS7_EE
...
//    void addMessage(std::string const&, std::vector<CommandOutputParameter> const&, long); //TODO: incomplete function definition // _ZN13CommandOutput10addMessageERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKSt6vectorI22CommandOutputParameterSaIS9_EE24CommandOutputMessageType
