...
public:
    virtual ~SpreadPlayersCommand(); // _ZN20SpreadPlayersCommandD2Ev
...
//    void setPlayerPositions(long &, BlockSource &, std::vector<Vec2> &); //TODO: incomplete function definition // _ZN20SpreadPlayersCommand18setPlayerPositionsER22CommandSelectorResultsI5ActorER11BlockSourceRSt6vectorI4Vec2SaIS7_EE
//    void spreadEntities(CommandOutput &, long &, BlockSource &, Vec2 const&, float, float); //TODO: incomplete function definition // _ZN20SpreadPlayersCommand14spreadEntitiesER13CommandOutputR22CommandSelectorResultsI5ActorER11BlockSourceRK4Vec2ff
};
