...
public:
    virtual ~ChestBlock(); // _ZN10ChestBlockD2Ev
    ...
    virtual bool shouldConnectToRedstone(BlockSource &, BlockPos const&, int)const; // _ZNK10ChestBlock23shouldConnectToRedstoneER11BlockSourceRK8BlockPosi
...
//    ChestBlock(std::string const&, int, long, long); //TODO: incomplete function definition // _ZN10ChestBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiNS_9ChestTypeE12MaterialType
