...
public:
    ...
    virtual ~BushBlock(); // _ZN9BushBlockD2Ev
...
//    void growCrops(BlockSource &, BlockPos const&, long)const; //TODO: incomplete function definition // _ZNK9BushBlock9growCropsER11BlockSourceRK8BlockPos14FertilizerType
};
