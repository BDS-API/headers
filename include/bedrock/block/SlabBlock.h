...
public:
    virtual ~SlabBlock(); // _ZN9SlabBlockD2Ev
...
//    SlabBlock(std::string const&, int, bool, Material const&, long); //TODO: incomplete function definition // _ZN9SlabBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEibRK8Material7WeakPtrI11BlockLegacyE
