...
public:
    virtual ~SignBlock(); // _ZN9SignBlockD2Ev
...
//    SignBlock(std::string const&, int, bool, long); //TODO: incomplete function definition // _ZN9SignBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEibN14SignBlockActor8SignTypeE
