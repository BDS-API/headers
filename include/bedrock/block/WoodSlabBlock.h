...
public:
    virtual ~WoodSlabBlock(); // _ZN13WoodSlabBlockD2Ev
...
//    WoodSlabBlock(std::string const&, int, bool, long); //TODO: incomplete function definition // _ZN13WoodSlabBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEib7WeakPtrI11BlockLegacyE
};
