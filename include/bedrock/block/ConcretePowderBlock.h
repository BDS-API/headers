...
public:
    virtual ~ConcretePowderBlock(); // _ZN19ConcretePowderBlockD2Ev
    ...
    virtual bool shouldStopFalling(Actor &)const; // _ZNK19ConcretePowderBlock17shouldStopFallingER5Actor
    ...
    void _tryTouchWater(BlockSource &, BlockPos const&, std::optional<long>)const; // _ZNK19ConcretePowderBlock14_tryTouchWaterER11BlockSourceRK8BlockPosSt8optionalI10BlockColorE
};
