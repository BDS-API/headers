...
public:
    virtual ~SkullBlockActor(); // _ZN15SkullBlockActorD2Ev
...
//    void setSkullType(long); //TODO: incomplete function definition // _ZN15SkullBlockActor12setSkullTypeENS_9SkullTypeE
