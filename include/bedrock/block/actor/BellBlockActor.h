...
public:
    virtual ~BellBlockActor(); // _ZN14BellBlockActorD2Ev
...
//    void ring(long, BlockSource &, bool); //TODO: incomplete function definition // _ZN14BellBlockActor4ringEN9Direction4TypeER11BlockSourceb
