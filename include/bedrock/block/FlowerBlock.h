...
public:
    virtual ~FlowerBlock(); // _ZN11FlowerBlockD2Ev
    ...
    virtual void onFertilized__incomplete0(BlockSource &, BlockPos const&, Actor *, long)const; //TODO: incomplete function definition // _ZNK11FlowerBlock12onFertilizedER11BlockSourceRK8BlockPosP5Actor14FertilizerType
...
//    FlowerBlock(std::string const&, int, long); //TODO: incomplete function definition // _ZN11FlowerBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiNS_4TypeE
