...
public:
    virtual ~SandBlock(); // _ZN9SandBlockD2Ev
    virtual void __fake_function0(); // fake
    virtual bool canBeOriginalSurface()const; // _ZNK9SandBlock20canBeOriginalSurfaceEv
    virtual void onFertilized__incomplete0(BlockSource &, BlockPos const&, Actor *, long)const; //TODO: incomplete function definition // _ZNK9SandBlock12onFertilizedER11BlockSourceRK8BlockPosP5Actor14FertilizerType
