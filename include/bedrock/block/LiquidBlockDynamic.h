...
public:
    virtual ~LiquidBlockDynamic(); // _ZN18LiquidBlockDynamicD2Ev
    ...
    bool shouldBecomeStatic(BlockSource &, BlockPos const&, Random &)const; // _ZNK18LiquidBlockDynamic18shouldBecomeStaticER11BlockSourceRK8BlockPosR6Random
