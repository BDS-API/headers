...
public:
    ...
    virtual ~StoneSlabBlock2(); // _ZN15StoneSlabBlock2D2Ev
...
//    StoneSlabBlock2(std::string const&, int, bool, long); //TODO: incomplete function definition // _ZN15StoneSlabBlock2C2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEib7WeakPtrI11BlockLegacyE
};
