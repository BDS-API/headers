...
public:
    ...
    virtual ~PlanksBlock(); // _ZN11PlanksBlockD2Ev
...
//    void getWoodMaterialColor(long); //TODO: incomplete function definition // _ZN11PlanksBlock20getWoodMaterialColorE8WoodType
