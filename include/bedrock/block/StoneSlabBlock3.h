...
public:
    ...
    virtual ~StoneSlabBlock3(); // _ZN15StoneSlabBlock3D2Ev
...
//    StoneSlabBlock3(std::string const&, int, bool, long); //TODO: incomplete function definition // _ZN15StoneSlabBlock3C2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEib7WeakPtrI11BlockLegacyE
};
