...
public:
    virtual ~BarrelBlock(); // _ZN11BarrelBlockD2Ev
    ...
    virtual bool shouldConnectToRedstone(BlockSource &, BlockPos const&, int)const; // _ZNK11BarrelBlock23shouldConnectToRedstoneER11BlockSourceRK8BlockPosi
