...
public:
    virtual ~PistonArmBlock(); // _ZN14PistonArmBlockD2Ev
    ...
    virtual bool canProvideSupport__incomplete0(Block const&, unsigned char, long)const; //TODO: incomplete function definition // _ZNK14PistonArmBlock17canProvideSupportERK5Blockh16BlockSupportType
...
//    PistonArmBlock(std::string const&, int, long); //TODO: incomplete function definition // _ZN14PistonArmBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiN11PistonBlock4TypeE
