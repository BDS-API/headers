...
public:
    ...
    virtual ~StoneSlabBlock4(); // _ZN15StoneSlabBlock4D2Ev
...
//    StoneSlabBlock4(std::string const&, int, bool, long); //TODO: incomplete function definition // _ZN15StoneSlabBlock4C2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEib7WeakPtrI11BlockLegacyE
};
