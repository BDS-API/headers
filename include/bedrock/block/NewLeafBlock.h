...
public:
    virtual ~NewLeafBlock(); // _ZN12NewLeafBlockD2Ev
...
//    NewLeafBlock(std::string const&, int, long); //TODO: incomplete function definition // _ZN12NewLeafBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEi7WeakPtrI11BlockLegacyE
};
