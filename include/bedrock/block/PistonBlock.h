...
public:
    ...
    virtual ~PistonBlock(); // _ZN11PistonBlockD2Ev
    virtual void __fake_function0(); // fake
    virtual bool canProvideSupport__incomplete0(Block const&, unsigned char, long)const; //TODO: incomplete function definition // _ZNK11PistonBlock17canProvideSupportERK5Blockh16BlockSupportType
    ...
    virtual bool shouldConnectToRedstone(BlockSource &, BlockPos const&, int)const; // _ZNK11PistonBlock23shouldConnectToRedstoneER11BlockSourceRK8BlockPosi
...
//    PistonBlock(std::string const&, int, long); //TODO: incomplete function definition // _ZN11PistonBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEiNS_4TypeE
