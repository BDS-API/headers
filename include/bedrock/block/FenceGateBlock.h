...
public:
    virtual ~FenceGateBlock(); // _ZN14FenceGateBlockD2Ev
...
//    FenceGateBlock(std::string const&, int, long); //TODO: incomplete function definition // _ZN14FenceGateBlockC2ERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEi8WoodType
