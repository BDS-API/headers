...
public:
    virtual ~ResourceLoader(); // _ZN14ResourceLoaderD2Ev
...
//    ResourceLoader(std::function<long (void)>); //TODO: incomplete function definition // _ZN14ResourceLoaderC2ESt8functionIFN4Core10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEEvEE
};
