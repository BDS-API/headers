...
public:
    virtual ~WorldHistoryPackSource(); // _ZN22WorldHistoryPackSourceD2Ev
...
//    WorldHistoryPackSource(Core::Path const&, long); //TODO: incomplete function definition // _ZN22WorldHistoryPackSourceC2ERKN4Core4PathE8PackType
//    std::string generateHistoryFilePath(Core::Path const&, long); //TODO: incomplete function definition // _ZN22WorldHistoryPackSource23generateHistoryFilePathB5cxx11ERKN4Core4PathE8PackType
