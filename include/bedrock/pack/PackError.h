...
public:
    virtual ~PackError(); // _ZN9PackErrorD2Ev
    virtual void __fake_function0(); // fake
    virtual std::string getLocErrorMessage()const; // _ZNK9PackError18getLocErrorMessageB5cxx11Ev
//    PackError(long, std::vector<std::string> const&); //TODO: incomplete function definition // _ZN9PackErrorC2E13PackErrorTypeRKSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS7_EE
