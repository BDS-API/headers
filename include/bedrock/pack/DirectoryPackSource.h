...
public:
    virtual ~DirectoryPackSource(); // _ZN19DirectoryPackSourceD2Ev
...
//    DirectoryPackSource(Core::Path const&, long, long, bool); //TODO: incomplete function definition // _ZN19DirectoryPackSourceC2ERKN4Core4PathE8PackType10PackOriginb
