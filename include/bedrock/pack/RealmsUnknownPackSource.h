...
public:
    virtual ~RealmsUnknownPackSource(); // _ZN23RealmsUnknownPackSourceD2Ev
...
//    RealmsUnknownPackSource(long, long); //TODO: incomplete function definition // _ZN23RealmsUnknownPackSourceC2E8PackType10PackOrigin
