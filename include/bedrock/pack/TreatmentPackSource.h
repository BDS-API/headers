...
public:
    virtual ~TreatmentPackSource(); // _ZN19TreatmentPackSourceD2Ev
...
//    TreatmentPackSource(Core::Path const&, long); //TODO: incomplete function definition // _ZN19TreatmentPackSourceC2ERKN4Core4PathE8PackType
