...
public:
    ...
    virtual ~PackManifest(); // _ZN12PackManifestD2Ev
    virtual void __fake_function0(); // fake
    virtual void clone()const; // _ZNK12PackManifest5cloneEv
//    PackManifest(long); //TODO: incomplete function definition // _ZN12PackManifestC2E12ManifestType
...
//    void setPackType(long); //TODO: incomplete function definition // _ZN12PackManifest11setPackTypeE8PackType
...
//    void setPackCategory(long); //TODO: incomplete function definition // _ZN12PackManifest15setPackCategoryE12PackCategory
//    void addPackCapability(long); //TODO: incomplete function definition // _ZN12PackManifest17addPackCapabilityEN3gsl17basic_string_spanIKcLln1EEE
//    bool hasPackCapability(long)const; //TODO: incomplete function definition // _ZNK12PackManifest17hasPackCapabilityEN3gsl17basic_string_spanIKcLln1EEE
...
//    std::string PackScopeToString(long); //TODO: incomplete function definition // _ZN12PackManifest17PackScopeToStringB5cxx11E9PackScope
...
//    void setPackOrigin(long); //TODO: incomplete function definition // _ZN12PackManifest13setPackOriginE10PackOrigin
...
//    bool isPremiumLocked(long &)const; //TODO: incomplete function definition // _ZNK12PackManifest15isPremiumLockedER19IEntitlementManager
...
//    void setManifestOrigin(long const&); //TODO: incomplete function definition // _ZN12PackManifest17setManifestOriginERK14ManifestOrigin
    void getManifestType()const; // _ZNK12PackManifest15getManifestTypeEv
//    void setManifestType(long const&); //TODO: incomplete function definition // _ZN12PackManifest15setManifestTypeERK12ManifestType
...
//    bool hasModuleType(long)const; //TODO: incomplete function definition // _ZNK12PackManifest13hasModuleTypeEN19ResourceInformation12ResourceTypeE
...
//    void setOptionLockedState(long); //TODO: incomplete function definition // _ZN12PackManifest20setOptionLockedStateE17TemplateLockState
    void getPackScope()const; // _ZNK12PackManifest12getPackScopeEv
//    void setPackScope(long); //TODO: incomplete function definition // _ZN12PackManifest12setPackScopeE9PackScope
//    void serialize(long, Json::Value &)const; //TODO: incomplete function definition // _ZNK12PackManifest9serializeE18PackManifestFormatRN4Json5ValueE
...
//    void setFormatVersion(long); //TODO: incomplete function definition // _ZN12PackManifest16setFormatVersionE18PackManifestFormat
    void getOriginalFormatVersion()const; // _ZNK12PackManifest24getOriginalFormatVersionEv
//    void setOriginalFormatVersion(long); //TODO: incomplete function definition // _ZN12PackManifest24setOriginalFormatVersionE18PackManifestFormat
    ...
    void setLocalizedNameKeywords(std::unordered_map<std::string, std::string, std::hash<std::string>, long, std::allocator<std::pair<std::string const, std::string>>> const&); // _ZN12PackManifest24setLocalizedNameKeywordsERKSt13unordered_mapINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES6_St4hashIS6_ESt8equal_toIS6_ESaISt4pairIKS6_S6_EEE
...
//        void registerCapability(long, bool); //TODO: incomplete function definition // _ZN12PackManifest18CapabilityRegistry18registerCapabilityEN3gsl17basic_string_spanIKcLln1EEEb
