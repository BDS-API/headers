...
public:
    virtual ~DirectoryPackWithEncryptionAccessStrategy(); // _ZN41DirectoryPackWithEncryptionAccessStrategyD2Ev
    ...
    virtual void deleteAsset__incomplete0(long const&); //TODO: incomplete function definition // _ZN41DirectoryPackWithEncryptionAccessStrategy11deleteAssetERKN4Core10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEE
