...
namespace RakNet {
    ...
    public:
        virtual ~RakNetSocket2(); // _ZN6RakNet13RakNetSocket2D2Ev
...
//        void SetSocketType(long); //TODO: incomplete function definition // _ZN6RakNet13RakNetSocket213SetSocketTypeENS_8RNS2TypeE
