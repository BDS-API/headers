...
//      void iterateOverDirectory(Core::Path const&, Core::DirectoryIterationFlags, std::function<Core::Result (Core::DirectoryIterationItem const&)>); //TODO: incomplete function definition
        ...
        void getDirectoryFiles(std::vector<Core::PathBuffer<std::string>> &, Core::Path const&);
        ...
        void getDirectoryFilesRecursively(std::vector<Core::PathBuffer<std::string>> &, Core::Path const&);
...
//      void cleanPathSeparators_deprecated(Core::PathBuffer<Core::StackString<char, 1024ul>> &, Core::Path const&); //TODO: incomplete function definition
        ...
        void _getDirectoriesAndFileSizesRecursively(Core::Path const&, std::vector<Core::PathBuffer<std::string>> &, std::vector<Core::FileSystem::BasicFileData> &);
        ...
        void _copyDirectoryStructure(Core::Path const&, Core::Path const&, std::vector<Core::PathBuffer<std::string>> const&, Core::FileSystemImpl *);
