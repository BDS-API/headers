...
//        void openFile(Core::Path const&, Core::File &, Core::FileOpenMode, long); //TODO: incomplete function definition // _ZN4Core10FileSystem8openFileERKNS_4PathERNS_4FileENS_12FileOpenModeENS_17FileBufferingModeE
//        void cleanPath_deprecated(long &, Core::Path const&); //TODO: incomplete function definition // _ZN4Core10FileSystem20cleanPath_deprecatedERNS_10PathBufferINS_11StackStringIcLm1024EEEEERKNS_4PathE
...
//        void iterateOverDirectory(Core::Path const&, long, std::function<Core::Result (Core::DirectoryIterationItem const&)>); //TODO: incomplete function definition // _ZN4Core10FileSystem20iterateOverDirectoryERKNS_4PathENS_23DirectoryIterationFlagsESt8functionIFNS_6ResultERKNS_22DirectoryIterationItemEEE
        void getDirectoryFiles(std::vector<long> &, Core::Path const&); // _ZN4Core10FileSystem17getDirectoryFilesERSt6vectorINS_10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEESaIS9_EERKNS_4PathE
        void getDirectoryFilesRecursively(std::vector<long> &, Core::Path const&); // _ZN4Core10FileSystem28getDirectoryFilesRecursivelyERSt6vectorINS_10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEESaIS9_EERKNS_4PathE
        ...
        void _getDirectoriesAndFileSizesRecursively(Core::Path const&, std::vector<long> &, std::vector<Core::FileSystem::BasicFileData> &); // _ZN4Core10FileSystem38_getDirectoriesAndFileSizesRecursivelyERKNS_4PathERSt6vectorINS_10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEESaISC_EERS4_INS0_13BasicFileDataESaISG_EE
...
//        void cleanPathSeparators_deprecated(long &, Core::Path const&); //TODO: incomplete function definition // _ZN4Core10FileSystem30cleanPathSeparators_deprecatedERNS_10PathBufferINS_11StackStringIcLm1024EEEEERKNS_4PathE
        void checkStorageCorrupt(Core::Path const&); // _ZN4Core10FileSystem19checkStorageCorruptERKNS_4PathE
        void _copyDirectoryStructure(Core::Path const&, Core::Path const&, std::vector<long> const&, Core::FileSystemImpl *); // _ZN4Core10FileSystem23_copyDirectoryStructureERKNS_4PathES3_RKSt6vectorINS_10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEESaISC_EEPNS_14FileSystemImplE
