...
//      virtual void _deleteRecursively(Core::Path const&, Core::FileType); //TODO: incomplete function definition
        ...
        virtual void _getDirectoryFiles(std::vector<Core::PathBuffer<std::string>> &, Core::Path const&);
        ...
        virtual void requestFlush(std::vector<Core::PathBuffer<std::string>> const&);
        virtual void _getDirectoryFilesRecursively(std::vector<Core::PathBuffer<std::string>> &, Core::Path const&);
