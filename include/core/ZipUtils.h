...
namespace Core {
    ...
    namespace ZipUtils {
        ...
        void zip(std::vector<long> const&, Core::Path const&, Core::ZipUtils::ZipProgress &, bool, std::function<std::string (Core::Path)>, Core::ZipUtils::ZipSettings const&); // _ZN4Core8ZipUtils3zipERKSt6vectorINS_10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEESaIS9_EERKNS_4PathERNS0_11ZipProgressEbSt8functionIFS8_SE_EERKNS0_11ZipSettingsE
...
//        void unzipToFlatFile(Core::Path const&, Core::Path const&, Core::ZipUtils::ZipProgress &, long, Core::ZipUtils::UnzipSettings const&); //TODO: incomplete function definition // _ZN4Core8ZipUtils15unzipToFlatFileERKNS_4PathES3_RNS0_11ZipProgressENS_17FileBufferingModeERKNS0_13UnzipSettingsE
        void _zipEncodedPathToUTF8(Core::Path const&); // _ZN4Core8ZipUtils21_zipEncodedPathToUTF8ERKNS_4PathE
        void getFilenames(Core::Path const&, std::vector<long> &, Core::ZipUtils::UnzipSettings const&); // _ZN4Core8ZipUtils12getFilenamesERKNS_4PathERSt6vectorINS_10PathBufferINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEESaISC_EERKNS0_13UnzipSettingsE
