...
public:
    ...
    void _set(GameRule::Value const&, GameRule::ValidationError *);
    void getBool(void)const;
    void setBool(bool, GameRule::ValidationError *);
    void getInt(void)const;
    void setInt(int, GameRule::ValidationError *);
    void getFloat(void)const;
    void setFloat(float, GameRule::ValidationError *);
