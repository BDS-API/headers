...
class BlastFurnaceBlockActor : FurnaceBlockActor {
    ...
    virtual void BlastFurnaceBlockActor::~BlastFurnaceBlockActor();
    virtual void BlastFurnaceBlockActor::~BlastFurnaceBlockActor();
    ...
    virtual void _ZNK22BlastFurnaceBlockActor7getNameB5cxx11Ev;
    ...
    virtual void ;
    virtual void `non-virtual thunk to'BlastFurnaceBlockActor::~BlastFurnaceBlockActor();
    virtual void `non-virtual thunk to'BlastFurnaceBlockActor::~BlastFurnaceBlockActor();
