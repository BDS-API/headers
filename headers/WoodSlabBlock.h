...
class WoodSlabBlock : SlabBlock {
    ...
    virtual void Wood~WoodSlabBlock();
    virtual void Wood~WoodSlabBlock();
    ...
    virtual void WoodisValidAuxValue(int)const;
    ...
    virtual void WoodgetResourceItem(Random &, Block const&, int)const;
    virtual void WoodasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void _ZNK13WoodSlabBlock18buildDescriptionIdB5cxx11ERK5Block;
    ...
    virtual void WoodgetVariant(Block const&)const;
    ...
    virtual void WoodgetSilkTouchItemInstance(Block const&)const;
