...
class ClothBlockItem : BlockItem {
    ...
    virtual void Cloth~ClothBlockItem();
    virtual void Cloth~ClothBlockItem();
    ...
    virtual void ClothgetLevelDataForAuxValue(int)const;
    ...
    virtual void _ZNK14ClothBlockItem18buildDescriptionIdB5cxx11ERK14ItemDescriptorRKSt10unique_ptrI11CompoundTagSt14default_deleteIS4_EE;
