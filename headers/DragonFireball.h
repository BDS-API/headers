...
class DragonFireball : Fireball {
    ...
    virtual void Actor::initializeComponents(Actor::InitializationMethod, VariantParameterList const&);
    ...
    virtual void Dragon~DragonFireball();
    virtual void Dragon~DragonFireball();
    ...
    virtual void DragonisPickable(void);
    ...
    virtual void Dragon_hurt(ActorDamageSource const&, int, bool, bool);
    ...
    virtual void DragongetTrailParticle(void);
    virtual void DragonshouldBurn(void);
}
