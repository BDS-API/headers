...
class ShulkerBoxBlockItem : AuxDataBlockItem {
    ...
    virtual void ~ShulkerBoxBlockItem();
    virtual void ~ShulkerBoxBlockItem();
    ...
    virtual void BlockItem::isExperimental(ItemDescriptor const*)const;
    ...
    virtual void Item::isThrowable(void)const;
    ...
    virtual void BlockItem::isDestructive(int)const;
    ...
    virtual void BlockItem::isValidAuxValue(int)const;
    ...
    virtual void Item::use(ItemStack &, Player &)const;
    virtual void Item::dispense(BlockSource &, Container &, int, Vec3 const&, unsigned char)const;
    ...
    virtual void _ZNK19ShulkerBoxBlockItem18buildDescriptionIdB5cxx11ERK14ItemDescriptorRKSt10unique_ptrI11CompoundTagSt14default_deleteIS4_EE;
    virtual void _ZNK19ShulkerBoxBlockItem26buildEffectDescriptionNameB5cxx11ERK13ItemStackBase;
    ...
    virtual void BlockItem::isEmissive(int)const;
    virtual void BlockItem::getIcon(ItemStackBase const&, int, bool)const;
    virtual void BlockItem::getIconYOffset(void)const;
    ...
    virtual void BlockItem::_calculatePlacePos(ItemStack &, Actor &, unsigned char &, BlockPos &)const;
    virtual void Item::_useOn(ItemInstance &, Actor &, BlockPos, unsigned char, float, float, float)const;
    virtual void BlockItem::_useOn(ItemStack &, Actor &, BlockPos, unsigned char, float, float, float)const;
}
