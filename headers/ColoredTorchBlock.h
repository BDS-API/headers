...
class ColoredTorchBlock : TorchBlock {
    ...
    virtual void Colored~ColoredTorchBlock();
    virtual void Colored~ColoredTorchBlock();
    ...
    virtual void ColoredcanBeUsedInCommands(bool)const;
    ...
    virtual void ColoredgetResourceItem(Random &, Block const&, int)const;
    virtual void ColoredasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void ColoredgetPlacementBlock(Actor &, BlockPos const&, unsigned char, Vec3 const&, int)const;
    ...
    virtual void _ZNK17ColoredTorchBlock18buildDescriptionIdB5cxx11ERK5Block;
    virtual void ColoredisAuxValueRelevantForPicking(void)const;
    ...
    virtual void ColoredgetVariant(Block const&)const;
    ...
    virtual void ColoredanimateTick(BlockSource &, BlockPos const&, Random &)const;
