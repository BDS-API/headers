...
class ElementBlockItem : ChemistryAuxDataBlockItem {
    ...
    virtual void AuxDataBlockItem::getLevelDataForAuxValue(int)const;
    ...
    virtual void _ZNK16AuxDataBlockItem18buildDescriptionIdB5cxx11ERK14ItemDescriptorRKSt10unique_ptrI11CompoundTagSt14default_deleteIS4_EE;
