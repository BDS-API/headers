...
class BambooSapling : Sapling {
    ...
    virtual void Bamboo~BambooSapling();
    virtual void Bamboo~BambooSapling();
    virtual void Bambootick(BlockSource &, BlockPos const&, Random &)const;
    ...
    virtual void BamboorandomlyModifyPosition(BlockPos const&)const;
    ...
    virtual void BushBlock::getAABB(BlockSource &, BlockPos const&, Block const&, AABB &, bool)const;
    ...
    virtual void BambooisValidAuxValue(int)const;
    ...
    virtual void BushBlock::waterSpreadCausesSpawn(void)const;
    virtual void BamboocanContainLiquid(void)const;
    ...
    virtual void BambooonFertilized(BlockSource &, BlockPos const&, Actor *, FertilizerType)const;
    ...
    virtual void BamboomayPlace(BlockSource &, BlockPos const&)const;
    virtual void BushBlock::mayPlaceOn(BlockSource &, BlockPos const&)const;
    ...
    virtual void BambooneighborChanged(BlockSource &, BlockPos const&, BlockPos const&)const;
    ...
    virtual void BamboogetResourceItem(Random &, Block const&, int)const;
    virtual void BambooasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void BambooplayerDestroy(Player &, BlockPos const&, Block const&)const;
    virtual void BamboocanSurvive(BlockSource &, BlockPos const&)const;
    ...
    virtual void _ZNK7Sapling18buildDescriptionIdB5cxx11ERK5Block;
    virtual void BambooisAuxValueRelevantForPicking(void)const;
    ...
    virtual void BamboogetVariant(Block const&)const;
    ...
    virtual void BamboogetSilkTouchItemInstance(Block const&)const;
    ...
    virtual void BushBlock::checkAlive(BlockSource &, BlockPos const&)const;
}
