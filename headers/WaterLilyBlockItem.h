...
class WaterLilyBlockItem : BlockItem {
    ...
    virtual void WaterLily~WaterLilyBlockItem();
    virtual void WaterLily~WaterLilyBlockItem();
    ...
    virtual void WaterLilyisLiquidClipItem(int)const;
    ...
    virtual void WaterLily_useOn(ItemStack &, Actor &, BlockPos, unsigned char, float, float, float)const;
}
