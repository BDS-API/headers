...
public:
    ...
    void LevelContainerModel(ContainerEnumName, int, Player &, BlockActorType, BlockPos const&, ContainerCategory);
    void LevelContainerModel(ContainerEnumName, int, Player &, ActorUniqueID, ContainerCategory);
