...
class BambooBlockItem : BlockItem {
    ...
    virtual void Bamboo~BambooBlockItem();
    virtual void Bamboo~BambooBlockItem();
    ...
    virtual void BamboogetLevelDataForAuxValue(int)const;
    ...
    virtual void Bamboo_useOn(ItemStack &, Actor &, BlockPos, unsigned char, float, float, float)const;
}
