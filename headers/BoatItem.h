...
class BoatItem : Item {
    ...
    virtual void BoatisStackedByData(void)const;
    ...
    virtual void BoatisLiquidClipItem(int)const;
    ...
    virtual void BoatisValidAuxValue(int)const;
    ...
    virtual void Boatdispense(BlockSource &, Container &, int, Vec3 const&, unsigned char)const;
    ...
    virtual void _ZNK8BoatItem18buildDescriptionIdB5cxx11ERK14ItemDescriptorRKSt10unique_ptrI11CompoundTagSt14default_deleteIS4_EE;
    ...
    virtual void BoatgetIcon(ItemStackBase const&, int, bool)const;
    virtual void getIconYOffset(void)const;
    virtual void BoatsetIcon(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&, int);
    ...
    virtual void Boat_useOn(ItemStack &, Actor &, BlockPos, unsigned char, float, float, float)const;
}
