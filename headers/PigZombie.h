...
class PigZombie : Zombie {
    ...
    virtual void PignormalTick(void);
    ...
    virtual void PigfindAttackTarget(void);
    ...
    virtual void Pig_hurt(ActorDamageSource const&, int, bool, bool);
    virtual void Actor::markHurt(void);
    virtual void PigreadAdditionalSaveData(CompoundTag const&, DataLoadHelper &);
    virtual void PigaddAdditionalSaveData(CompoundTag &);
    ...
    virtual void PigcheckSpawnRules(bool);
    ...
    virtual void HumanoidMonster::doHurtTarget(Actor *);
    ...
    virtual void PiggetAttackTime(void);
