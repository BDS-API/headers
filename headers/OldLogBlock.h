...
class OldLogBlock : LogBlock {
    ...
    virtual void BlockLegacy::getAABB(BlockSource &, BlockPos const&, Block const&, AABB &, bool)const;
    ...
    virtual void OldisStrippable(Block const&)const;
    virtual void OldgetStrippedBlock(Block const&)const;
    ...
    virtual void BlockLegacy::neighborChanged(BlockSource &, BlockPos const&, BlockPos const&)const;
    virtual void BlockLegacy::getSecondPart(BlockSource &, BlockPos const&, BlockPos&)const;
    virtual void getResourceCount(Random &, Block const&, int)const;
    virtual void OldgetResourceItem(Random &, Block const&, int)const;
    virtual void OldasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void RotatedPillarBlock::getPlacementBlock(Actor &, BlockPos const&, unsigned char, Vec3 const&, int)const;
    ...
    virtual void _ZNK11OldLogBlock18buildDescriptionIdB5cxx11ERK5Block;
    virtual void OldisAuxValueRelevantForPicking(void)const;
    ...
    virtual void OldgetVariant(Block const&)const;
    virtual void BlockLegacy::canSpawnOn(void)const;
    virtual void RotatedPillarBlock::getMappedFace(unsigned char, Block const&)const;
    ...
    virtual void BlockLegacy::canBeSilkTouched(void)const;
    virtual void OldgetSilkTouchItemInstance(Block const&)const;
