...
class WoodSlabBlockItem : SlabBlockItem {
    ...
    virtual void Wood~WoodSlabBlockItem();
    virtual void Wood~WoodSlabBlockItem();
    ...
    virtual void WoodgetLevelDataForAuxValue(int)const;
    ...
    virtual void Wood_calculatePlacePos(ItemStack &, Actor &, unsigned char &, BlockPos &)const;
