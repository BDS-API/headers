...
class FaceDirectionalActorBlock : ActorBlock {
    ...
    virtual void FaceDirectional~FaceDirectionalActorBlock();
    virtual void FaceDirectional~FaceDirectionalActorBlock();
    ...
    virtual void FaceDirectionalgetPlacementBlock(Actor &, BlockPos const&, unsigned char, Vec3 const&, int)const;
    ...
    virtual void FaceDirectionalgetMappedFace(unsigned char, Block const&)const;
    virtual void FaceDirectionalgetFaceFlip(unsigned char, Block const&)const;
