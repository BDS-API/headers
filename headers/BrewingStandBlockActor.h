...
class BrewingStandBlockActor : BlockActor, Container {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'BrewingStandBlockActor::~BrewingStandBlockActor();
    virtual void `non-virtual thunk to'BrewingStandBlockActor::~BrewingStandBlockActor();
    ...
    virtual void `non-virtual thunk to'BrewingStandBlockActor::getItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'BrewingStandBlockActor::setItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'BrewingStandBlockActor::getContainerSize(void)const;
    virtual void `non-virtual thunk to'BrewingStandBlockActor::getMaxStackSize(void)const;
    virtual void `non-virtual thunk to'BrewingStandBlockActor::startOpen(Player &);
    virtual void `non-virtual thunk to'BrewingStandBlockActor::stopOpen(Player &);
    ...
    virtual void `non-virtual thunk to'BrewingStandBlockActor::canPushInItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void `non-virtual thunk to'BrewingStandBlockActor::canPullOutItem(BlockSource &, int, int, ItemInstance const&)const;
