...
class IContentAccessibilityProvider : IContentKeyProvider {
    ...
    virtual void IContentAccessibilityProvider::~IContentAccessibilityProvider();
    virtual void IContentAccessibilityProvider::~IContentAccessibilityProvider();
    virtual void _ZNK24IContentAccessibilityProvider13getContentKeyB5cxx11ERK15ContentIdentity;
