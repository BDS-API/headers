...
public:
    ...
    void StructurePoolElement(StructureManager &, std::string, Projection);
    void _getTemplate(void)const;
    void StructurePoolElement(StructureManager &, std::string, std::vector<std::unique_ptr<StructurePoolBlockRule, std::default_delete<StructurePoolBlockRule>>, std::allocator<std::unique_ptr<StructurePoolBlockRule, std::default_delete<StructurePoolBlockRule>>>> const*, std::vector const*<std::unique_ptr<StructurePoolBlockTagRule, std::default_delete<std::vector const>>, std::allocator<StructurePoolBlockTagRule>>, std::vector const*<std::unique_ptr<StructurePoolActorRule, std::default_delete<std::vector const>>, std::allocator<StructurePoolActorRule>>, Projection);
