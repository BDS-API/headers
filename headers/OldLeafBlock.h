...
class OldLeafBlock : LeafBlock {
    ...
    virtual void OldplayerDestroy(Player &, BlockPos const&, Block const&)const;
    ...
    virtual void OldgetMapColor(BlockSource &, BlockPos const&)const;
    ...
    virtual void _ZNK12OldLeafBlock18buildDescriptionIdB5cxx11ERK5Block;
    ...
    virtual void OldgetColor(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void OldgetRenderLayer(Block const&, BlockSource &, BlockPos const&)const;
    ...
    virtual void OldgetExtraResourceItem(Block const&)const;
}
