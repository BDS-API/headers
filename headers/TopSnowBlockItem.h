...
class TopSnowBlockItem : BlockItem {
    ...
    virtual void TopSnow~TopSnowBlockItem();
    virtual void TopSnow~TopSnowBlockItem();
    ...
    virtual void TopSnowgetLevelDataForAuxValue(int)const;
    ...
    virtual void TopSnow_useOn(ItemStack &, Actor &, BlockPos, unsigned char, float, float, float)const;
}
