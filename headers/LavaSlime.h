...
class LavaSlime : Slime {
    ...
    virtual void LavareloadHardcoded(Actor::InitializationMethod, VariantParameterList const&);
    ...
    virtual void LavaisInLava(void)const;
    ...
    virtual void LavagetBrightness(float)const;
    ...
    virtual void LavaisOnFire(void)const;
    ...
    virtual void LavacheckSpawnRules(bool);
    ...
    virtual void LavagetArmorValue(void);
    ...
    virtual void LavajumpFromGround(void);
