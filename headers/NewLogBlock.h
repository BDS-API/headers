...
class NewLogBlock : LogBlock {
    ...
    virtual void NewisStrippable(Block const&)const;
    virtual void NewgetStrippedBlock(Block const&)const;
    ...
    virtual void NewgetResourceItem(Random &, Block const&, int)const;
    virtual void NewasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void _ZNK11NewLogBlock18buildDescriptionIdB5cxx11ERK5Block;
    ...
    virtual void NewgetVariant(Block const&)const;
    ...
    virtual void NewgetSilkTouchItemInstance(Block const&)const;
