...
class CoralFanBlockItem : BlockItem {
    ...
    virtual void CoralFan~CoralFanBlockItem();
    virtual void CoralFan~CoralFanBlockItem();
    ...
    virtual void CoralFangetLevelDataForAuxValue(int)const;
    ...
    virtual void CoralFanisValidAuxValue(int)const;
    ...
    virtual void CoralFan_useOn(ItemStack &, Actor &, BlockPos, unsigned char, float, float, float)const;
}
