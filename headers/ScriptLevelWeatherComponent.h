...
class ScriptLevelWeatherComponent : ScriptTemplateFactory_ltScriptServerContext_ge::Component {
    ...
    virtual void ScriptLevelWeatherComponent::~ScriptLevelWeatherComponent();
    virtual void ScriptLevelWeatherComponent::~ScriptLevelWeatherComponent();
    ...
    virtual void hasComponent(ScriptApi::ScriptVersionInfo const&, ScriptEngine &, ScriptServerContext &, Level &, bool &)const;
