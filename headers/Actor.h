...
public:
    ...
    void Actor(ActorDefinitionGroup *, ActorDefinitionIdentifier const&);
    ...
    void sendActorDefinitionEventTriggered(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&);
    bool hasType(ActorType)const;
    void executeEvent(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&, VariantParameterList const&);
    ...
    void addDefinitionGroup(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&);
    void removeDefinitionGroup(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&);
    bool hasDefinitionGroup(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&)const;
    bool hasFamily(Util::HashString const&)const;
    bool hasTag(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&)const;
