...
class CampfireBlockActor : BlockActor {
    ...
    virtual void Campfire~CampfireBlockActor();
    virtual void Campfire~CampfireBlockActor();
    virtual void Campfireload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void Campfiresave(CompoundTag &)const;
    virtual void saveItemInstanceData(CompoundTag &);
    virtual void saveBlockData(CompoundTag &, BlockSource &)const;
    virtual void loadBlockData(CompoundTag const&, BlockSource &, DataLoadHelper &);
    virtual void onCustomTagLoadDone(BlockSource &);
    virtual void Campfiretick(BlockSource &);
    virtual void isFinished(void);
    virtual void CampfireonChanged(BlockSource &);
    virtual void isMovable(BlockSource &);
    virtual void isCustomNameSaved(void);
    virtual void CampfiregetUpdatePacket(BlockSource &);
    virtual void onPlace(BlockSource &);
    virtual void CampfireonUpdatePacket(CompoundTag const&, BlockSource &);
    virtual void onMove(void);
    virtual void onRemoved(BlockSource &);
    virtual void triggerEvent(int, int);
    virtual void clearCache(void);
    virtual void onNeighborChanged(BlockSource &, BlockPos const&);
    virtual void CampfiregetShadowRadius(BlockSource &)const;
