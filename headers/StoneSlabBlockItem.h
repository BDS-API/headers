...
class StoneSlabBlockItem : SlabBlockItem {
    ...
    virtual void Stone~StoneSlabBlockItem();
    virtual void Stone~StoneSlabBlockItem();
    ...
    virtual void StonegetLevelDataForAuxValue(int)const;
    ...
    virtual void _ZNK9BlockItem18buildDescriptionIdB5cxx11ERK14ItemDescriptorRKSt10unique_ptrI11CompoundTagSt14default_deleteIS4_EE;
    ...
    virtual void Stone_calculatePlacePos(ItemStack &, Actor &, unsigned char &, BlockPos &)const;
