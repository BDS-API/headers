...
class SaplingBlockItem : BlockItem {
    ...
    virtual void Sapling~SaplingBlockItem();
    virtual void Sapling~SaplingBlockItem();
    ...
    virtual void SaplinggetLevelDataForAuxValue(int)const;
    ...
    virtual void _ZNK16SaplingBlockItem18buildDescriptionIdB5cxx11ERK14ItemDescriptorRKSt10unique_ptrI11CompoundTagSt14default_deleteIS4_EE;
