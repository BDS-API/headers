...
class SweetBerryBushBlock : BushBlock {
    ...
    virtual void SweetBerry~SweetBerryBushBlock();
    virtual void SweetBerry~SweetBerryBushBlock();
    virtual void SweetBerrytick(BlockSource &, BlockPos const&, Random &)const;
    ...
    virtual void SweetBerrygetAABB(BlockSource &, BlockPos const&, Block const&, AABB &, bool)const;
    ...
    virtual void SweetBerryisCropBlock(void)const;
    ...
    virtual void SweetBerryisInteractiveBlock(void)const;
    ...
    virtual void SweetBerrycanContainLiquid(void)const;
    ...
    virtual void SweetBerrycheckIsPathable(Actor &, BlockPos const&, BlockPos const&)const;
    ...
    virtual void SweetBerryonFertilized(BlockSource &, BlockPos const&, Actor *, FertilizerType)const;
    virtual void BlockLegacy::mayConsumeFertilizer(BlockSource &)const;
    ...
    virtual void SweetBerrymayPlace(BlockSource &, BlockPos const&)const;
    virtual void SweetBerrymayPlaceOn(BlockSource &, BlockPos const&)const;
    ...
    virtual void SweetBerrygetResourceCount(Random &, Block const&, int)const;
    virtual void BlockLegacy::getResourceItem(Random &, Block const&, int)const;
    virtual void SweetBerryasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    virtual void SweetBerryspawnResources(BlockSource &, BlockPos const&, Block const&, float, int)const;
    ...
    virtual void SweetBerryuse(Player &, BlockPos const&)const;
    ...
    virtual void SweetBerryattack(Player *, BlockPos const&)const;
    virtual void BlockLegacy::handleEntityInside(BlockSource &, BlockPos const&, Actor *, Vec3 &)const;
    virtual void SweetBerryentityInside(BlockSource &, BlockPos const&, Actor &)const;
    virtual void BlockLegacy::playerDestroy(Player &, BlockPos const&, Block const&)const;
    virtual void SweetBerrycanSurvive(BlockSource &, BlockPos const&)const;
    ...
    virtual void SweetBerryexecuteEvent(BlockSource &, BlockPos const&, Block const&, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&)const;
    virtual void SweetBerryhasTag(BlockSource &, BlockPos const&, Block const&, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&)const;
    virtual void BlockLegacy::getMobToSpawn(SpawnConditions const&, BlockSource &)const;
    virtual void BlockLegacy::getMapColor(BlockSource &, BlockPos const&)const;
    ...
    virtual void SweetBerrygetRenderLayer(void)const;
    ...
    virtual void BlockLegacy::getColor(Block const&)const;
    virtual void BlockLegacy::getColorAtPos(BlockSource &, BlockPos const&)const;
    virtual void BlockLegacy::getColor(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void SweetBerrygetRenderLayer(Block const&, BlockSource &, BlockPos const&)const;
    ...
    virtual void SweetBerrygetVisualShape(Block const&, AABB &, bool)const;
    ...
    virtual void SweetBerrygetVariant(Block const&)const;
    ...
    virtual void SweetBerrycanBeSilkTouched(void)const;
    ...
    virtual void SweetBerrydealsContactDamage(Actor const&, Block const&, bool)const;
