...
class RandomizableBlockActorContainer : RandomizableBlockActorContainerBase, Container {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'RandomizableBlockActorContainer::~RandomizableBlockActorContainer();
    virtual void `non-virtual thunk to'RandomizableBlockActorContainer::~RandomizableBlockActorContainer();
    ...
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void `non-virtual thunk to'RandomizableBlockActorContainer::startOpen(Player &);
    virtual void `non-virtual thunk to'RandomizableBlockActorContainer::setItem(int, ItemStack const&);
