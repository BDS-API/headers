...
class SeaPickleBlockItem : BlockItem {
    ...
    virtual void SeaPickle~SeaPickleBlockItem();
    virtual void SeaPickle~SeaPickleBlockItem();
    ...
    virtual void SeaPicklegetLevelDataForAuxValue(int)const;
    ...
    virtual void SeaPickle_useOn(ItemStack &, Actor &, BlockPos, unsigned char, float, float, float)const;
}
