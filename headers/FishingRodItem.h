...
class FishingRodItem : Item {
    ...
    virtual void FishingRod~FishingRodItem();
    virtual void FishingRod~FishingRodItem();
    ...
    virtual void FishingRodisHandEquipped(void)const;
    ...
    virtual void FishingRodrequiresInteract(void)const;
    ...
    virtual void FishingRodgetEnchantSlot(void)const;
    virtual void FishingRodgetEnchantValue(void)const;
    ...
    virtual void FishingRoduse(ItemStack &, Player &)const;
    ...
    virtual void FishingRodhurtEnemy(ItemStack &, Mob *, Mob *)const;
    virtual void mineBlock(ItemInstance &, Block const&, int, int, int, Actor *)const;
    virtual void FishingRodmineBlock(ItemStack &, Block const&, int, int, int, Actor *)const;
    ...
    virtual void _ZNK14FishingRodItem15getInteractTextB5cxx11ERK6Player;
    virtual void FishingRodgetAnimationFrameFor(Mob *, bool, ItemStack const*, bool)const;
    virtual void isEmissive(int)const;
    virtual void FishingRodgetIcon(ItemStackBase const&, int, bool)const;
    virtual void getIconYOffset(void)const;
    virtual void FishingRodsetIcon(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&, int);
