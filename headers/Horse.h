...
class Horse : Animal {
    ...
    virtual void Mob::readAdditionalSaveData(CompoundTag const&, DataLoadHelper &);
    virtual void Mob::addAdditionalSaveData(CompoundTag &);
    ...
    virtual void canWearArmor(void)const;
    virtual void getHasReproduced(void)const;
    virtual void setBred(bool);
    virtual void setReproduced(bool);
    virtual void isAmuletHorse(void);
    virtual void isUndead(void)const;
    virtual void isSterile(void)const;
    virtual void isAdult(void)const;
    virtual void isEating(void)const;
    virtual void isBred(void)const;
    ...
    virtual void _ZN5Horse11getMadSoundB5cxx11Ev;
}
