...
class RedstoneTorchBlock : TorchBlock {
    ...
    virtual void Redstone~RedstoneTorchBlock();
    virtual void Redstone~RedstoneTorchBlock();
    ...
    virtual void RedstoneisSignalSource(void)const;
    ...
    virtual void RedstoneshouldConnectToRedstone(BlockSource &, BlockPos const&, int)const;
    ...
    virtual void RedstoneonPlace(BlockSource &, BlockPos const&)const;
    ...
    virtual void RedstoneonRedstoneUpdate(BlockSource &, BlockPos const&, int, bool)const;
    ...
    virtual void RedstonesetupRedstoneComponent(BlockSource &, BlockPos const&)const;
    ...
    virtual void RedstoneneighborChanged(BlockSource &, BlockPos const&, BlockPos const&)const;
    ...
    virtual void RedstonegetResourceItem(Random &, Block const&, int)const;
    virtual void RedstoneasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void RedstonecanSpawnOn(void)const;
    ...
    virtual void RedstoneanimateTick(BlockSource &, BlockPos const&, Random &)const;
    ...
    virtual void RedstonegetSilkTouchItemInstance(Block const&)const;
    ...
    virtual void RedstonegetTickDelay(void);
}
