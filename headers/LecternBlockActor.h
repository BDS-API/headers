...
class LecternBlockActor : BlockActor, Container {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'LecternBlockActor::~LecternBlockActor();
    virtual void `non-virtual thunk to'LecternBlockActor::~LecternBlockActor();
    ...
    virtual void `non-virtual thunk to'LecternBlockActor::getItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'LecternBlockActor::setItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'LecternBlockActor::getContainerSize(void)const;
    virtual void `non-virtual thunk to'LecternBlockActor::getMaxStackSize(void)const;
    virtual void `non-virtual thunk to'LecternBlockActor::startOpen(Player &);
    virtual void `non-virtual thunk to'LecternBlockActor::stopOpen(Player &);
