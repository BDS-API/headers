...
class LecternBlockActor : BlockActor, Container {
    ...
    virtual void Lectern~LecternBlockActor();
    virtual void Lectern~LecternBlockActor();
    virtual void Lecternload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void Lecternsave(CompoundTag &)const;
    ...
    virtual void LecternonChanged(BlockSource &);
    virtual void isMovable(BlockSource &);
    virtual void isCustomNameSaved(void);
    virtual void LecterngetUpdatePacket(BlockSource &);
    virtual void onPlace(BlockSource &);
    virtual void LecternonUpdatePacket(CompoundTag const&, BlockSource &);
    ...
    virtual void LecterngetItem(int)const;
    virtual void LecternsetItem(int, ItemStack const&);
    virtual void LecterngetMaxStackSize(void)const;
    virtual void LecterngetContainerSize(void)const;
    virtual void LecternstartOpen(Player &);
    virtual void LecternstopOpen(Player &);
    virtual void ;
    virtual void `non-virtual thunk to'Lectern~LecternBlockActor();
    virtual void `non-virtual thunk to'Lectern~LecternBlockActor();
    ...
    virtual void `non-virtual thunk to'LecterngetItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'LecternsetItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'LecterngetContainerSize(void)const;
    virtual void `non-virtual thunk to'LecterngetMaxStackSize(void)const;
    virtual void `non-virtual thunk to'LecternstartOpen(Player &);
    virtual void `non-virtual thunk to'LecternstopOpen(Player &);
