...
class StoneSlabBlock : SlabBlock {
    ...
    virtual void Stone~StoneSlabBlock();
    virtual void Stone~StoneSlabBlock();
    ...
    virtual void StoneisValidAuxValue(int)const;
    ...
    virtual void StonegetResourceItem(Random &, Block const&, int)const;
    virtual void StoneasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    ...
    virtual void _ZNK14StoneSlabBlock18buildDescriptionIdB5cxx11ERK5Block;
    ...
    virtual void StonegetVariant(Block const&)const;
    ...
    virtual void StonegetSilkTouchItemInstance(Block const&)const;
