...
class EnderChestBlock : ChestBlock {
    ...
    virtual void Ender~EnderChestBlock();
    virtual void Ender~EnderChestBlock();
    ...
    virtual void EndergetResourceCount(Random &, Block const&, int)const;
    virtual void EndergetResourceItem(Random &, Block const&, int)const;
    ...
    virtual void EnderanimateTick(BlockSource &, BlockPos const&, Random &)const;
    ...
    virtual void EndercanBeSilkTouched(void)const;
