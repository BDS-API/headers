...
class ChalkboardBlockActor : BlockActor {
    ...
    virtual void Chalkboard~ChalkboardBlockActor();
    virtual void Chalkboard~ChalkboardBlockActor();
    virtual void Chalkboardload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void Chalkboardsave(CompoundTag &)const;
    ...
    virtual void ChalkboardonChanged(BlockSource &);
    virtual void isMovable(BlockSource &);
    virtual void isCustomNameSaved(void);
    virtual void ChalkboardgetUpdatePacket(BlockSource &);
    virtual void onPlace(BlockSource &);
    virtual void ChalkboardonUpdatePacket(CompoundTag const&, BlockSource &);
    virtual void onMove(void);
    virtual void onRemoved(BlockSource &);
    virtual void triggerEvent(int, int);
    virtual void clearCache(void);
    virtual void onNeighborChanged(BlockSource &, BlockPos const&);
    virtual void ChalkboardgetShadowRadius(BlockSource &)const;
