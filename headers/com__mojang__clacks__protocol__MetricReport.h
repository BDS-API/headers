...
class com::mojang::clacks::protocol::MetricReport : google::protobuf::Message {
...
public:
    ...
    void MetricReport(void);
    void SharedCtor(void);
    void MetricReport(com::mojang::clacks::protocol::MetricReport const&);
