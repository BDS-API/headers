...
class UndyedShulkerBoxBlock : ShulkerBoxBlock {
    ...
    virtual void Undyed~UndyedShulkerBoxBlock();
    virtual void Undyed~UndyedShulkerBoxBlock();
    virtual void BlockLegacy::tick(BlockSource &, BlockPos const&, Random &)const;
    ...
    virtual void ChestBlock::isContainerBlock(void)const;
    virtual void BlockLegacy::isCraftingBlock(void)const;
    virtual void ChestBlock::isInteractiveBlock(void)const;
    ...
    virtual void ChestBlock::isSignalSource(void)const;
    ...
    virtual void BlockLegacy::waterSpreadCausesSpawn(void)const;
    virtual void BlockLegacy::canContainLiquid(void)const;
    virtual void ChestBlock::shouldConnectToRedstone(BlockSource &, BlockPos const&, int)const;
    ...
    virtual void ChestBlock::onPlace(BlockSource &, BlockPos const&)const;
    virtual void ChestBlock::onRemove(BlockSource &, BlockPos const&)const;
    ...
    virtual void ChestBlock::onMove(BlockSource &, BlockPos const&, BlockPos const&)const;
    virtual void ChestBlock::detachesOnPistonMove(BlockSource &, BlockPos const&)const;
    ...
    virtual void BlockLegacy::onFertilized(BlockSource &, BlockPos const&, Actor *, FertilizerType)const;
    ...
    virtual void BlockLegacy::mayPlaceOn(BlockSource &, BlockPos const&)const;
    ...
    virtual void ActorBlock::neighborChanged(BlockSource &, BlockPos const&, BlockPos const&)const;
    virtual void ChestBlock::getSecondPart(BlockSource &, BlockPos const&, BlockPos&)const;
    ...
    virtual void ChestBlock::use(Player &, BlockPos const&)const;
    ...
    virtual void BlockLegacy::canSurvive(BlockSource &, BlockPos const&)const;
    ...
    virtual void ActorBlock::triggerEvent(BlockSource &, BlockPos const&, int, int)const;
    ...
    virtual void ChestBlock::hasComparatorSignal(void)const;
    virtual void ChestBlock::getComparatorSignal(BlockSource &, BlockPos const&, Block const&, unsigned char)const;
    ...
    virtual void UndyedgetColor(Block const&)const;
    ...
    virtual void ChestBlock::getMappedFace(unsigned char, Block const&)const;
    ...
    virtual void ChestBlock::init(void);
    ...
    virtual void ActorBlock::canBeSilkTouched(void)const;
    ...
    virtual void ActorBlock::getEntityResourceItem(Random &, BlockActor const&, int)const;
}
