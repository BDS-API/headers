...
class UnderwaterTorchBlock : TorchBlock {
    ...
    virtual void Underwater~UnderwaterTorchBlock();
    virtual void Underwater~UnderwaterTorchBlock();
    ...
    virtual void UnderwaterisWaterBlocking(void)const;
    ...
    virtual void UnderwatercanContainLiquid(void)const;
    ...
    virtual void UnderwatercanBeUsedInCommands(bool)const;
    ...
    virtual void UnderwatermayPlace(BlockSource &, BlockPos const&)const;
    ...
    virtual void UnderwateranimateTick(BlockSource &, BlockPos const&, Random &)const;
