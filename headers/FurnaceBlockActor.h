...
class FurnaceBlockActor : BlockActor, Container {
    ...
    virtual void Furnace~FurnaceBlockActor();
    virtual void Furnace~FurnaceBlockActor();
    virtual void Furnaceload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void Furnacesave(CompoundTag &)const;
    virtual void saveItemInstanceData(CompoundTag &);
    virtual void saveBlockData(CompoundTag &, BlockSource &)const;
    virtual void loadBlockData(CompoundTag const&, BlockSource &, DataLoadHelper &);
    virtual void FurnaceonCustomTagLoadDone(BlockSource &);
    virtual void Furnacetick(BlockSource &);
    virtual void FurnaceisFinished(void);
    virtual void onChanged(BlockSource &);
    virtual void isMovable(BlockSource &);
    virtual void isCustomNameSaved(void);
    virtual void FurnacegetUpdatePacket(BlockSource &);
    virtual void onPlace(BlockSource &);
    virtual void FurnaceonUpdatePacket(CompoundTag const&, BlockSource &);
    virtual void FurnaceonMove(void);
    virtual void onRemoved(BlockSource &);
    virtual void triggerEvent(int, int);
    virtual void clearCache(void);
    virtual void FurnaceonNeighborChanged(BlockSource &, BlockPos const&);
    ...
    virtual void _ZNK17FurnaceBlockActor7getNameB5cxx11Ev;
    ...
    virtual void FurnacegetContainer(void);
    virtual void getDeletionDelayTimeSeconds(void)const;
    virtual void onChunkLoaded(LevelChunk &);
    virtual void onChunkUnloaded(LevelChunk &);
    virtual void FurnacegetItem(int)const;
    virtual void FurnacesetItem(int, ItemStack const&);
    virtual void FurnacegetMaxStackSize(void)const;
    virtual void FurnacegetContainerSize(void)const;
    virtual void FurnacestartOpen(Player &);
    virtual void FurnacestopOpen(Player &);
    virtual void FurnacecanPushInItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void FurnacecanPullOutItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void ;
    virtual void `non-virtual thunk to'Furnace~FurnaceBlockActor();
    virtual void `non-virtual thunk to'Furnace~FurnaceBlockActor();
    ...
    virtual void `non-virtual thunk to'FurnacegetItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'FurnacesetItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'FurnacegetContainerSize(void)const;
    virtual void `non-virtual thunk to'FurnacegetMaxStackSize(void)const;
    virtual void `non-virtual thunk to'FurnacestartOpen(Player &);
    virtual void `non-virtual thunk to'FurnacestopOpen(Player &);
    ...
    virtual void `non-virtual thunk to'FurnacecanPushInItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void `non-virtual thunk to'FurnacecanPullOutItem(BlockSource &, int, int, ItemInstance const&)const;
