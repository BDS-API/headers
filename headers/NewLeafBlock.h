...
class NewLeafBlock : LeafBlock {
    ...
    virtual void NewplayerDestroy(Player &, BlockPos const&, Block const&)const;
    ...
    virtual void _ZNK12NewLeafBlock18buildDescriptionIdB5cxx11ERK5Block;
    ...
    virtual void NewgetExtraResourceItem(Block const&)const;
}
