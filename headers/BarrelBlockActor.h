...
class BarrelBlockActor : ChestBlockActor {
    ...
    virtual void _ZNK16BarrelBlockActor7getNameB5cxx11Ev;
    ...
    virtual void ;
    virtual void `non-virtual thunk to'BarrelBlockActor::~BarrelBlockActor();
    virtual void `non-virtual thunk to'BarrelBlockActor::~BarrelBlockActor();
    ...
    virtual void `non-virtual thunk to'BarrelBlockActor::startOpen(Player &);
    virtual void `non-virtual thunk to'BarrelBlockActor::stopOpen(Player &);
    ...
    virtual void `non-virtual thunk to'ChestBlockActor::canPushInItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void `non-virtual thunk to'ChestBlockActor::canPullOutItem(BlockSource &, int, int, ItemInstance const&)const;
