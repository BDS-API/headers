...
class ShulkerBoxBlockActor : ChestBlockActor {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'ShulkerBoxBlockActor::~ShulkerBoxBlockActor();
    virtual void `non-virtual thunk to'ShulkerBoxBlockActor::~ShulkerBoxBlockActor();
    ...
    virtual void `non-virtual thunk to'ShulkerBoxBlockActor::getMaxStackSize(void)const;
    ...
    virtual void `non-virtual thunk to'ShulkerBoxBlockActor::canPushInItem(BlockSource &, int, int, ItemInstance const&)const;
