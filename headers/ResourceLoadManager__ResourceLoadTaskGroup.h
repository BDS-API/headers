...
class ResourceLoadManager::ResourceLoadTaskGroup {

public:

    void ResourceLoadTaskGroup(gsl::basic_string_span<char const, -1l>, ResourceLoadType, std::vector<ResourceLoadType, std::allocator<ResourceLoadType>>, Scheduler &, WorkerPool &);
