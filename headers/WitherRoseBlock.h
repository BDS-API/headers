...
class WitherRoseBlock : FlowerBlock {
    ...
    virtual void ~WitherRoseBlock();
    virtual void ~WitherRoseBlock();
    virtual void BushBlock::tick(BlockSource &, BlockPos const&, Random &)const;
    ...
    virtual void BushBlock::neighborChanged(BlockSource &, BlockPos const&, BlockPos const&)const;
    ...
    virtual void BushBlock::canSurvive(BlockSource &, BlockPos const&)const;
    ...
    virtual void _ZNK15WitherRoseBlock18buildDescriptionIdB5cxx11ERK5Block;
