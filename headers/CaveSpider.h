...
class CaveSpider : Spider {
    ...
    virtual void CavegetDebugText(std::vector<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>>, std::allocator<std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>>>> &);
    ...
    virtual void Monster::readAdditionalSaveData(CompoundTag const&, DataLoadHelper &);
    virtual void Monster::addAdditionalSaveData(CompoundTag &);
    ...
    virtual void Monster::_getWalkTargetValue(BlockPos const&);
    ...
    virtual void Monster::isDarkEnoughToSpawn(void)const;
    virtual void CavegetModelScale(void)const;
    virtual void CavegetSpiderType(void)const;
}
