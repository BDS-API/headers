...
class BlastFurnaceBlock : FurnaceBlock {
    ...
    virtual void Blast~BlastFurnaceBlock();
    virtual void Blast~BlastFurnaceBlock();
    ...
    virtual void ActorBlock::playerWillDestroy(Player &, BlockPos const&, Block const&)const;
    ...
    virtual void BlastgetResourceItem(Random &, Block const&, int)const;
    virtual void BlastasItemInstance(BlockSource &, BlockPos const&, Block const&)const;
    virtual void ActorBlock::spawnResources(BlockSource &, BlockPos const&, Block const&, float, int)const;
    ...
    virtual void Blastuse(Player &, BlockPos const&)const;
    ...
    virtual void BlastgetSilkTouchItemInstance(Block const&)const;
