...
class EnderChestBlockActor : ChestBlockActor {
    ...
    virtual void Ender~EnderChestBlockActor();
    virtual void Ender~EnderChestBlockActor();
    ...
    virtual void EndercanPushInItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void EndercanPullOutItem(BlockSource &, int, int, ItemInstance const&)const;
    ...
    virtual void EnderplayOpenSound(BlockSource &);
    virtual void EnderplayCloseSound(BlockSource &);
    ...
    virtual void ;
    virtual void `non-virtual thunk to'Ender~EnderChestBlockActor();
    virtual void `non-virtual thunk to'Ender~EnderChestBlockActor();
    ...
    virtual void `non-virtual thunk to'EndercanPushInItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void `non-virtual thunk to'EndercanPullOutItem(BlockSource &, int, int, ItemInstance const&)const;
