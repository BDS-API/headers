...
class DispenserBlockActor : RandomizableBlockActorContainer {
    ...
    virtual void _ZNK19DispenserBlockActor7getNameB5cxx11Ev;
    ...
    virtual void ;
    virtual void `non-virtual thunk to'DispenserBlockActor::~DispenserBlockActor();
    virtual void `non-virtual thunk to'DispenserBlockActor::~DispenserBlockActor();
    ...
    virtual void `non-virtual thunk to'DispenserBlockActor::getItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'DispenserBlockActor::setItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void `non-virtual thunk to'RandomizableBlockActorContainer::dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'DispenserBlockActor::getContainerSize(void)const;
    virtual void `non-virtual thunk to'DispenserBlockActor::getMaxStackSize(void)const;
    virtual void `non-virtual thunk to'DispenserBlockActor::startOpen(Player &);
    virtual void `non-virtual thunk to'DispenserBlockActor::stopOpen(Player &);
