...
class DispenserBlockActor : RandomizableBlockActorContainer {
    ...
    virtual void ~DispenserBlockActor();
    virtual void ~DispenserBlockActor();
    ...
    virtual void ;
    virtual void `non-virtual thunk to'~DispenserBlockActor();
    virtual void `non-virtual thunk to'~DispenserBlockActor();
    ...
    virtual void `non-virtual thunk to'dropContents(BlockSource &, Vec3 const&, bool);
