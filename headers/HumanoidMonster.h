...
class HumanoidMonster : Monster {
    ...
    virtual void Humanoid~HumanoidMonster();
    virtual void Humanoid~HumanoidMonster();
    ...
    virtual void HumanoidreadAdditionalSaveData(CompoundTag const&, DataLoadHelper &);
    virtual void HumanoidaddAdditionalSaveData(CompoundTag &);
    ...
    virtual void HumanoiddoHurtTarget(Actor *);
