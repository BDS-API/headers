...
class JukeboxBlockActor : RandomizableBlockActorContainer {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'JukeboxBlockActor::~JukeboxBlockActor();
    virtual void `non-virtual thunk to'JukeboxBlockActor::~JukeboxBlockActor();
    ...
    virtual void `non-virtual thunk to'JukeboxBlockActor::getItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'JukeboxBlockActor::setItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void `non-virtual thunk to'RandomizableBlockActorContainer::dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'JukeboxBlockActor::getContainerSize(void)const;
    virtual void `non-virtual thunk to'JukeboxBlockActor::getMaxStackSize(void)const;
    virtual void `non-virtual thunk to'JukeboxBlockActor::startOpen(Player &);
    virtual void `non-virtual thunk to'JukeboxBlockActor::stopOpen(Player &);
    ...
    virtual void `non-virtual thunk to'JukeboxBlockActor::canPushInItem(BlockSource &, int, int, ItemInstance const&)const;
    virtual void `non-virtual thunk to'JukeboxBlockActor::canPullOutItem(BlockSource &, int, int, ItemInstance const&)const;
