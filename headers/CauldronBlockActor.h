...
class CauldronBlockActor : BlockActor, Container {
    ...
    virtual void Cauldron~CauldronBlockActor();
    virtual void Cauldron~CauldronBlockActor();
    virtual void Cauldronload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void Cauldronsave(CompoundTag &)const;
    virtual void saveItemInstanceData(CompoundTag &);
    virtual void saveBlockData(CompoundTag &, BlockSource &)const;
    virtual void loadBlockData(CompoundTag const&, BlockSource &, DataLoadHelper &);
    virtual void onCustomTagLoadDone(BlockSource &);
    virtual void Cauldrontick(BlockSource &);
    virtual void CauldronisFinished(void);
    virtual void CauldrononChanged(BlockSource &);
    virtual void isMovable(BlockSource &);
    virtual void isCustomNameSaved(void);
    virtual void CauldrongetUpdatePacket(BlockSource &);
    virtual void onPlace(BlockSource &);
    virtual void CauldrononUpdatePacket(CompoundTag const&, BlockSource &);
    ...
    virtual void _ZNK18CauldronBlockActor7getNameB5cxx11Ev;
    ...
    virtual void CauldrongetItem(int)const;
    virtual void CauldronsetItem(int, ItemStack const&);
    virtual void CauldrongetMaxStackSize(void)const;
    virtual void CauldrongetContainerSize(void)const;
    virtual void CauldronstartOpen(Player &);
    virtual void CauldronstopOpen(Player &);
    virtual void ;
    virtual void `non-virtual thunk to'Cauldron~CauldronBlockActor();
    virtual void `non-virtual thunk to'Cauldron~CauldronBlockActor();
    ...
    virtual void `non-virtual thunk to'CauldrongetItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'CauldronsetItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'CauldrongetContainerSize(void)const;
    virtual void `non-virtual thunk to'CauldrongetMaxStackSize(void)const;
    virtual void `non-virtual thunk to'CauldronstartOpen(Player &);
    virtual void `non-virtual thunk to'CauldronstopOpen(Player &);
