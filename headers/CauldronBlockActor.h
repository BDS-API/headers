...
class CauldronBlockActor : BlockActor, Container {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'CauldronBlockActor::~CauldronBlockActor();
    virtual void `non-virtual thunk to'CauldronBlockActor::~CauldronBlockActor();
    ...
    virtual void `non-virtual thunk to'CauldronBlockActor::getItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'CauldronBlockActor::setItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'CauldronBlockActor::getContainerSize(void)const;
    virtual void `non-virtual thunk to'CauldronBlockActor::getMaxStackSize(void)const;
    virtual void `non-virtual thunk to'CauldronBlockActor::startOpen(Player &);
    virtual void `non-virtual thunk to'CauldronBlockActor::stopOpen(Player &);
