...
class EnderpearlItem : Item {
    ...
    virtual void Enderpearl~EnderpearlItem();
    virtual void Enderpearl~EnderpearlItem();
    ...
    virtual void EnderpearlisThrowable(void)const;
    ...
    virtual void Enderpearluse(ItemStack &, Player &)const;
    ...
    virtual void EnderpearlgetCooldownType(void)const;
    virtual void EnderpearlgetCooldownTime(void)const;
