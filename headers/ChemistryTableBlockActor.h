...
class ChemistryTableBlockActor : BlockActor, Container {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::~ChemistryTableBlockActor();
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::~ChemistryTableBlockActor();
    ...
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::getItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::setItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::getContainerSize(void)const;
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::getMaxStackSize(void)const;
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::startOpen(Player &);
    virtual void `non-virtual thunk to'ChemistryTableBlockActor::stopOpen(Player &);
