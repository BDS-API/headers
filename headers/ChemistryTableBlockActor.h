...
class ChemistryTableBlockActor : BlockActor, Container {
    ...
    virtual void ChemistryTable~ChemistryTableBlockActor();
    virtual void ChemistryTable~ChemistryTableBlockActor();
    virtual void ChemistryTableload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void ChemistryTablesave(CompoundTag &)const;
    virtual void saveItemInstanceData(CompoundTag &);
    virtual void saveBlockData(CompoundTag &, BlockSource &)const;
    virtual void loadBlockData(CompoundTag const&, BlockSource &, DataLoadHelper &);
    virtual void onCustomTagLoadDone(BlockSource &);
    virtual void ChemistryTabletick(BlockSource &);
    ...
    virtual void ChemistryTableonRemoved(BlockSource &);
    ...
    virtual void ChemistryTablegetContainer(void);
    virtual void getDeletionDelayTimeSeconds(void)const;
    virtual void onChunkLoaded(LevelChunk &);
    virtual void onChunkUnloaded(LevelChunk &);
    virtual void ChemistryTablegetItem(int)const;
    virtual void ChemistryTablesetItem(int, ItemStack const&);
    virtual void ChemistryTablegetMaxStackSize(void)const;
    virtual void ChemistryTablegetContainerSize(void)const;
    virtual void ChemistryTablestartOpen(Player &);
    virtual void ChemistryTablestopOpen(Player &);
    virtual void ;
    virtual void `non-virtual thunk to'ChemistryTable~ChemistryTableBlockActor();
    virtual void `non-virtual thunk to'ChemistryTable~ChemistryTableBlockActor();
    ...
    virtual void `non-virtual thunk to'ChemistryTablegetItem(int)const;
    virtual void hasRoomForItem(ItemStack const&);
    virtual void addItem(ItemStack &);
    virtual void addItemToFirstEmptySlot(ItemStack &);
    virtual void `non-virtual thunk to'ChemistryTablesetItem(int, ItemStack const&);
    virtual void removeItem(int, int);
    virtual void removeAllItems(void);
    virtual void dropContents(BlockSource &, Vec3 const&, bool);
    virtual void `non-virtual thunk to'ChemistryTablegetContainerSize(void)const;
    virtual void `non-virtual thunk to'ChemistryTablegetMaxStackSize(void)const;
    virtual void `non-virtual thunk to'ChemistryTablestartOpen(Player &);
    virtual void `non-virtual thunk to'ChemistryTablestopOpen(Player &);
