...
class NetherReactorBlockActor : BlockActor {
    ...
    virtual void NetherReactor~NetherReactorBlockActor();
    virtual void NetherReactor~NetherReactorBlockActor();
    virtual void NetherReactorload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void NetherReactorsave(CompoundTag &)const;
