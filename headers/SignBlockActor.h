...
class SignBlockActor : BlockActor {
    ...
    virtual void Sign~SignBlockActor();
    virtual void Sign~SignBlockActor();
    virtual void Signload(Level &, CompoundTag const&, DataLoadHelper &);
    virtual void Signsave(CompoundTag &)const;
    ...
    virtual void SignonChanged(BlockSource &);
    virtual void isMovable(BlockSource &);
    virtual void isCustomNameSaved(void);
    virtual void SigngetUpdatePacket(BlockSource &);
    virtual void onPlace(BlockSource &);
    virtual void SignonUpdatePacket(CompoundTag const&, BlockSource &);
    virtual void onMove(void);
    virtual void onRemoved(BlockSource &);
    virtual void triggerEvent(int, int);
    virtual void clearCache(void);
    virtual void onNeighborChanged(BlockSource &, BlockPos const&);
    virtual void SigngetShadowRadius(BlockSource &)const;
    ...
    virtual void _ZN14SignBlockActor22getImmersiveReaderTextB5cxx11ER11BlockSource;
