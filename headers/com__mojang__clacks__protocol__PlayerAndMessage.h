...
class com::mojang::clacks::protocol::PlayerAndMessage : google::protobuf::Message {
...
public:
    ...
    void PlayerAndMessage(void);
    void SharedCtor(void);
    void PlayerAndMessage(com::mojang::clacks::protocol::PlayerAndMessage const&);
