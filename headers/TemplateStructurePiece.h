...
class TemplateStructurePiece : StructurePiece {
    ...
    virtual void Template~TemplateStructurePiece();
    virtual void Template~TemplateStructurePiece();
    virtual void TemplatemoveBoundingBox(int, int, int);
    virtual void asPoolElement(void);
    virtual void getType(void)const;
    virtual void addChildren(StructurePiece*, std::vector<std::unique_ptr<StructurePiece, std::default_delete<StructurePiece>>, std::allocator<std::unique_ptr<StructurePiece, std::default_delete<StructurePiece>>>> &, Random &);
    virtual void TemplatepostProcess(BlockSource *, Random &, BoundingBox const&);
    ...
    virtual void Template_handleDataMarker(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&, BlockPos const&, BlockSource &, Random &, BoundingBox const&);
}
