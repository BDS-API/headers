...
class TheEndDimension : Dimension {
    ...
    virtual void ;
    virtual void `non-virtual thunk to'TheEndDimension::~TheEndDimension();
    virtual void `non-virtual thunk to'TheEndDimension::~TheEndDimension();
    virtual void `non-virtual thunk to'TheEndDimension::deserialize(CompoundTag const&);
    virtual void `non-virtual thunk to'TheEndDimension::serialize(CompoundTag &)const;
}
