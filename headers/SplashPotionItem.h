...
class SplashPotionItem : PotionItem {
    ...
    virtual void Splash~SplashPotionItem();
    virtual void Splash~SplashPotionItem();
    ...
    virtual void SplashisThrowable(void)const;
    ...
    virtual void SplashappendFormattedHovertext(ItemStackBase const&, Level &, std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> &, bool)const;
    ...
    virtual void Splashuse(ItemStack &, Player &)const;
    virtual void Splashdispense(BlockSource &, Container &, int, Vec3 const&, unsigned char)const;
    ...
    virtual void _ZNK16SplashPotionItem18buildDescriptionIdB5cxx11ERK14ItemDescriptorRKSt10unique_ptrI11CompoundTagSt14default_deleteIS4_EE;
    ...
    virtual void SplashgetIcon(ItemStackBase const&, int, bool)const;
    virtual void Item::getIconYOffset(void)const;
    virtual void SplashsetIcon(std::__cxx11::basic_string<char, std::char_traits<char>, std::allocator<char>> const&, int);
    ...
    virtual void SplashgetPotionType(void)const;
}
