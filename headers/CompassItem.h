...
class CompassItem : Item {
    ...
    virtual void Compass~CompassItem();
    virtual void Compass~CompassItem();
    ...
    virtual void CompassgetAnimationFrameFor(Mob *, bool, ItemStack const*, bool)const;
    virtual void isEmissive(int)const;
    virtual void CompassgetIcon(ItemStackBase const&, int, bool)const;
